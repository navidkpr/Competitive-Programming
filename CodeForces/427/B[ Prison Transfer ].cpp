...
<head>
    ...
    <meta name="X-Csrf-Token" content="169881886b11e9ab8456061c37d238f3"/>
    ...
    <meta property="og:title" content="Submission #14224532 - Codeforces"/>
    ...
    <title>Submission #14224532 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='169881886b11e9ab8456061c37d238f3'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F427%2Fsubmission%2F14224532">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='169881886b11e9ab8456061c37d238f3'/>
...
int main()
{
	...
	int cnt = 0;
	if ((*st.rbegin()).first <= t)
		cnt++;
	for (int i = c; i < n; i++)
	{
		st.insert(make_pair(arr[i], i));
		st.erase(make_pair(arr[i - c], i - c));
		if ((*st.rbegin()).first <= t)
			cnt++;
	}
	cout << cnt << endl;
