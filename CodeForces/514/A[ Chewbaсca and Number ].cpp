...
<head>
    ...
    <meta name="X-Csrf-Token" content="b257c29fd6c7636bbccbec5955713919"/>
    ...
    <meta property="og:title" content="Submission #12707656 - Codeforces"/>
    ...
    <title>Submission #12707656 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='b257c29fd6c7636bbccbec5955713919'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F514%2Fsubmission%2F12707656">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b257c29fd6c7636bbccbec5955713919'/>
...
int main()
{
	...
	if (arr[0] == 9)
		...
		cout << min(arr[0], 9 - arr[0]);
	for (int i = 1; i < n; i++)
		cout << min(arr[i], 9 - arr[i]);
	return 0;
}
