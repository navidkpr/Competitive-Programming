...
<head>
    ...
    <meta name="X-Csrf-Token" content="baabfcbc7ed2a5b7d43cc8248b4c586a"/>
    ...
    <meta property="og:title" content="Submission #14280243 - Codeforces"/>
    ...
    <title>Submission #14280243 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='baabfcbc7ed2a5b7d43cc8248b4c586a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F514%2Fsubmission%2F14280243">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='baabfcbc7ed2a5b7d43cc8248b4c586a'/>
...
int main()
{
	...
	for (int i = 0; i < n; i++)
	{
		...
		for (int j = 0; j < n; j++)
			if (x[i] == x1 && x[j] == x1)
				mrk[j] = 1;
			else if (y[i] == y1 && y[j] == y1)
				mrk[j] = 1;
			else if (y[j] == y1 || x[i] == x1)
				continue;
			else if ((y[i] - y1) / (x[i] - x1) == (y[j] - y1) / (x[j] - x1))
				mrk[j] = 1;
		cnt++;
	}
	cout << cnt << endl;
