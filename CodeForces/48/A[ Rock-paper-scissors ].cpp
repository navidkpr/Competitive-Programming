...
<head>
    ...
    <meta name="X-Csrf-Token" content="af26f871f8bb74ab92e9eb273bc4fd0e"/>
    ...
    <meta property="og:title" content="Submission #15749412 - Codeforces"/>
    ...
    <meta name="cc" content="341cbff9e7d74bee21ce849cd15c756aecaa4666"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15749412 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='af26f871f8bb74ab92e9eb273bc4fd0e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F48%2Fsubmission%2F15749412">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='af26f871f8bb74ab92e9eb273bc4fd0e'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/48">Problems</a></li>
        <li><a
                                        href="/contest/48/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/48/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/48/status">Status</a></li>
        <li><a
                                        href="/contest/48/standings">Standings</a></li>
        <li><a
                                        href="/contest/48/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - Rock-paper-scissors" href="/contest/48/problem/A">48A</a>
...
int32_t main()
{
	...
	for (int i = 0; i < n; i++)
		cin >> arr[i];
	if (arr[0] == "rock" && arr[1] == "scissors" && arr[2] == "scissors")
		cout << &#39;F&#39; << endl;
	else if (arr[0] == "paper" && arr[1] == "rock" && arr[2] == "rock")
		cout << &#39;F&#39; << endl;
	else if (arr[0] == "scissors" && arr[1] == "paper" && arr[2] == "paper")
		cout << &#39;F&#39; << endl;
	else if (arr[1] == "rock" && arr[0] == "scissors" && arr[2] == "scissors")
		cout << &#39;M&#39; << endl;
	else if (arr[1] == "paper" && arr[0] == "rock" && arr[2] == "rock")
		cout << &#39;M&#39; << endl;
	else if (arr[1] == "scissors" && arr[0] == "paper" && arr[2] == "paper")
		cout << &#39;M&#39; << endl;
	else if (arr[2] == "rock" && arr[1] == "scissors" && arr[0] == "scissors")
		cout << &#39;S&#39; << endl;
	else if (arr[2] == "paper" && arr[1] == "rock" && arr[0] == "rock")
		cout << &#39;S&#39; << endl;
	else if (arr[2] == "scissors" && arr[1] == "paper" && arr[0] == "paper")
		cout << &#39;S&#39; << endl;
	else
		cout << "?" << endl;
	return 0;
