...
<head>
    ...
    <meta name="X-Csrf-Token" content="b1b690fec608887b088d14da08dfbce7"/>
    ...
    <meta property="og:title" content="Submission #16020013 - Codeforces"/>
    ...
    <title>Submission #16020013 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='b1b690fec608887b088d14da08dfbce7'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F48%2Fsubmission%2F16020013">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b1b690fec608887b088d14da08dfbce7'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="D - Permutations" href="/contest/48/problem/D">48D</a>
...
int32_t main()
{
	...
	while (cnt)
	{
		...
		int pt_2 = 1;
		while (pt[pt_2].size() > 0)
		{
			mrk[pt[pt_2][pt[pt_2].size() - 1]] = cnt_2;
			pt[pt_2].pop_back();
			cnt--;
			pt_2++;
		}
	...
	cout << *max_element(mrk, mrk + n) << endl;
	for (int i = 0; i < n; i++)
		cout << mrk[i] << &#39; &#39;;
	cout << endl;
}