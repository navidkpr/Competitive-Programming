...
<head>
    ...
    <meta name="X-Csrf-Token" content="277dd0bb32ab1243faaeb7223b31ab76"/>
    ...
    <meta property="og:title" content="Submission #15988417 - Codeforces"/>
    ...
    <meta name="cc" content="d5b6d0726ca5b38872d4a9b1f5dc6a2c42222a67"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15988417 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='277dd0bb32ab1243faaeb7223b31ab76'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F175%2Fsubmission%2F15988417">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='277dd0bb32ab1243faaeb7223b31ab76'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/175">Problems</a></li>
        <li><a
                                        href="/contest/175/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/175/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/175/status">Status</a></li>
        <li><a
                                        href="/contest/175/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/175/room/1">Room</a></li>
        <li><a
                                        href="/contest/175/standings">Standings</a></li>
        <li><a
                                        href="/contest/175/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - Robot Bicorn Attack" href="/contest/175/problem/A">175A</a>
...
int32_t main()
{
	...
	for (int i = 1; i < s.size(); i++)
		...
		{
			if (i - 1 > 7 || j - i > 7 || s.size() - j > 7)
				continue;
			string num1 = s.substr(0, i), num2 = s.substr(i, j - i), num3 = s.substr(j, s.size() - j);
			...
			if (num3.size() > 1 && num3[0] == &#39;0&#39;)
				continue;
			if (give_int(num1) > 1000000 || give_int(num2) > 1000000 || give_int(num3) > 1000000)
				continue;
			cerr << num1 << &#39; &#39; << num2 << &#39; &#39; << num3 << endl;
			max_sum = max(max_sum, give_int(num1) + give_int(num2) + give_int(num3));
		}
	cout << max_sum << endl;
}