...
<head>
    ...
    <meta name="X-Csrf-Token" content="cb94cd0e2d344fa7bb6d22fae712a9a9"/>
    ...
    <meta property="og:title" content="Submission #15598932 - Codeforces"/>
    ...
    <meta name="cc" content="c0bccd7f3c422d2033eb0ca40d7d81607f885bea"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15598932 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='cb94cd0e2d344fa7bb6d22fae712a9a9'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F382%2Fsubmission%2F15598932">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='cb94cd0e2d344fa7bb6d22fae712a9a9'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    ...
    <td>2016-01-26 20:54:43</td>
    <td>2016-01-26 20:54:44</td>
    <td>
...
int main()
{
	...
	if (abs(cnt_1 - cnt_2) > s2.size() || s2.size() % 2 != abs(cnt_1 - cnt_2) % 2)
	{
		cout << "Impossible" << endl;
		return 0;
	}
	int dif = abs(cnt_1 - cnt_2);
	int num_1 = cnt_1, num_2 = cnt_2;
	int cnt_kol = s2.size();
	cnt_kol -= dif;
	if (num_1 < num_2)
		num_1 += dif;
	...
	num_1 += cnt_kol / 2;
	num_2 += cnt_kol / 2;
	// cerr << num_1 << &#39; &#39; << num_2 << endl;
	for (int i = 0; i < num_1 - cnt_1; i++)
		cout << s2[i];
	for (int i = 0; i < s1.size(); i++)
		cout << s1[i];
	for (int i = num_1 - cnt_1; i < s2.size(); i++)
		cout << s2[i];
	cout << endl;
	return 0;
}