...
<head>
    ...
    <meta name="X-Csrf-Token" content="aa4d57f349772218d3e94aa58392586c"/>
    ...
    <meta property="og:title" content="Submission #14327497 - Codeforces"/>
    ...
    <meta name="cc" content="6d3fb634f1cfa25bc040dfa2b2414d343f32eeff"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #14327497 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='aa4d57f349772218d3e94aa58392586c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F485%2Fsubmission%2F14327497">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='aa4d57f349772218d3e94aa58392586c'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/485">Problems</a></li>
        <li><a
                                        href="/contest/485/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/485/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/485/status">Status</a></li>
        <li><a
                                        href="/contest/485/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/485/room/1">Room</a></li>
        <li><a
                                        href="/contest/485/standings">Standings</a></li>
        <li><a
                                        href="/contest/485/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="B - Valuable Resources" href="/contest/485/problem/B">485B</a>
...
int main()
{
	...
	for (int i = 0; i < n; i++)
		cin >> x[i] >> y[i];
	long long int min_x = INF, min_y = INF, max_x = -INF, max_y = -INF;
	for (int i = 0; i < n; i++)
	{
		min_x = min(min_x, x[i]);
		min_y = min(min_y, y[i]);
