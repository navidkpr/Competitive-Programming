...
<head>
    ...
    <meta name="X-Csrf-Token" content="4b94162fe0dc4596829e93b80c82d303"/>
    ...
    <meta property="og:title" content="Submission #15577349 - Codeforces"/>
    ...
    <title>Submission #15577349 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='4b94162fe0dc4596829e93b80c82d303'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F538%2Fsubmission%2F15577349">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='4b94162fe0dc4596829e93b80c82d303'/>
...
int main()
{
	...
	int max_h = -1;
	for (int i = 0; i < m - 1; i++)
		if (abs(arr[i].second - arr[i + 1].second) > arr[i + 1].first - arr[i].first)
		{
	...
	for (int i = 0; i < m - 1; i++)
		if (arr[i].second < arr[i + 1].second)
			max_h = max(max_h, arr[i].second + (arr[i + 1].second - arr[i].second + arr[i + 1].first - arr[i].first) / 2);
		else
			max_h = max(max_h, arr[i].second + (arr[i + 1].first - arr[i].first - arr[i].second + arr[i + 1].second) / 2);
	max_h = max(max_h, arr[0].first + arr[0].second - 1);
	max_h = max(max_h, n - arr[m - 1].first + arr[m - 1].second);
	cout << max_h << endl;
}