...
<head>
    ...
    <meta name="X-Csrf-Token" content="32383712e09c9bca2642ac397a674c1d"/>
    ...
    <meta property="og:title" content="Submission #18449253 - Codeforces"/>
    ...
    <meta name="cc" content="a95cbf1e9b2c868710bc79fa5ef212f020cb3339"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #18449253 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='32383712e09c9bca2642ac397a674c1d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F128%2Fsubmission%2F18449253">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='32383712e09c9bca2642ac397a674c1d'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/128">Problems</a></li>
        <li><a
                                        href="/contest/128/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/128/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/128/status">Status</a></li>
        <li><a
                                        href="/contest/128/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/128/room/1">Room</a></li>
        <li><a
                                        href="/contest/128/standings">Standings</a></li>
        <li><a
                                        href="/contest/128/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="C - Games with Rectangle" href="/contest/128/problem/C">128C</a>
...
int32_t main()
{
	...
	cout << (dp[2 * k][n - 1] * dp[2 * k][m - 1]) % MOD << endl;
	return 0;
}