...
<head>
    ...
    <meta name="X-Csrf-Token" content="e8b8264d1dd8ba2bd2aaf17c2f6a4c0f"/>
    ...
    <meta property="og:title" content="Submission #15981361 - Codeforces"/>
    ...
    <meta name="cc" content="96c7b6df39f75785ade09b9da00eada6ef7bb058"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15981361 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='e8b8264d1dd8ba2bd2aaf17c2f6a4c0f'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F17%2Fsubmission%2F15981361">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='e8b8264d1dd8ba2bd2aaf17c2f6a4c0f'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/17">Problems</a></li>
        <li><a
                                        href="/contest/17/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/17/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/17/status">Status</a></li>
        <li><a
                                        href="/contest/17/standings">Standings</a></li>
        <li><a
                                        href="/contest/17/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="B - Hierarchy" href="/contest/17/problem/B">17B</a>
...
int32_t main()
{
	...
	for (int i = 0; i < m; i++)
	{
		...
		x--;
		y--;
		all_edge.push_back(make_triple(x, y, z));
	}
	for (int i = 0; i < n; i++)
		moal[i] = i + 1;
	for (int i = 0; i < n; i++)
	...
	{
		int u = all_edge[i].first, v = all_edge[i].second, w = all_edge[i].third;
		if (moal[u] == moal[v] || p[v] != v)
			continue;
		sum += w;
		p[v] = u;
		// cerr << moal[u] << &#39; &#39; << moal[v] << endl;
		int moal_1 = moal[v];
		for (int j = 0; j < n; j++)
			if (moal[j] == moal_1)
				moal[j] = moal[u];
