...
<head>
    ...
    <meta name="X-Csrf-Token" content="76890230fd4c615ee3cc66cee225b0b5"/>
    ...
    <meta property="og:title" content="Submission #15751741 - Codeforces"/>
    ...
    <meta name="cc" content="5bc1411b21bfeccc59b54c6ff91cf3d2e43d60c8"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15751741 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='76890230fd4c615ee3cc66cee225b0b5'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F99%2Fsubmission%2F15751741">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='76890230fd4c615ee3cc66cee225b0b5'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/99">Problems</a></li>
        <li><a
                                        href="/contest/99/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/99/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/99/status">Status</a></li>
        <li><a
                                        href="/contest/99/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/99/room/1">Room</a></li>
        <li><a
                                        href="/contest/99/standings">Standings</a></li>
        <li><a
                                        href="/contest/99/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - Help Far Away Kingdom" href="/contest/99/problem/A">99A</a>
    ...
    <td>2016-02-02 17:09:29</td>
    <td>2016-02-02 17:09:30</td>
    <td>
...
int32_t main()
{
	...
	int pt = 0;
	while (s[pt] != &#39;.&#39; && pt != s.size())
		pt++;
	if (pt == s.size() || s[pt + 1] < &#39;5&#39;)
		for (int i = 0; i < pt; i++)
			cout << s[i];
	else
	{
