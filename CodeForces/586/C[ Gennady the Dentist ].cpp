...
<head>
    ...
    <meta name="X-Csrf-Token" content="0847f72b985cc9f5606fb4e6c0c68ccd"/>
    ...
    <meta property="og:title" content="Submission #13569366 - Codeforces"/>
    ...
    <title>Submission #13569366 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='0847f72b985cc9f5606fb4e6c0c68ccd'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F586%2Fsubmission%2F13569366">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0847f72b985cc9f5606fb4e6c0c68ccd'/>
...
<a href="/profile/kbl_didi_ridi" title="Specialist kbl_didi_ridi" class="rated-user user-cyan">kbl_didi_ridi</a>    </td>
    <td>
        <a title="C - Gennady the Dentist" href="/contest/586/problem/C">586C</a>
    ...
    <td>2015-10-12 13:46:20</td>
    <td>2015-10-12 17:34:01</td>
    <td>
...
int next1[MAXN];
int pre[MAXN];
long long int v[MAXN], d[MAXN], p[MAXN];
...
int main()
{
	...
	while (pt >= 0)
	{
		...
		while (ans != -1)
		{
			p[ans] -= max((long long)0, v[pt] - cnt);
			cnt++;
			if (p[ans] < 0)
			{
				run(ans);
				next1[pre[ans]] = next1[ans];
				pre[next1[ans]] = pre[ans];
			}
			ans = next1[ans];
		}
		pt = next1[pt];	
