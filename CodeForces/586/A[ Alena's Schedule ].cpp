...
<head>
    ...
    <meta name="X-Csrf-Token" content="cb1879be6d69a1d32f5781c18568018e"/>
    ...
    <meta property="og:title" content="Submission #13563566 - Codeforces"/>
    ...
    <title>Submission #13563566 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='cb1879be6d69a1d32f5781c18568018e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F586%2Fsubmission%2F13563566">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='cb1879be6d69a1d32f5781c18568018e'/>
...
<a href="/profile/kbl_didi_ridi" title="Specialist kbl_didi_ridi" class="rated-user user-cyan">kbl_didi_ridi</a>    </td>
    ...
    <td>2015-10-12 12:57:59</td>
    <td>2015-10-12 17:33:14</td>
    <td>
...
int main()
{
	...
	while (arr[pt] == 0 && pt < n)
		pt++;
	int pt_2 = n - 1;
	while (arr[pt_2] == 0 && pt_2 >= 0)
		pt_2--;
	int cnt = 0;
	for (int i = pt; i <= pt_2; i++)
		if (arr[i] == 1)
			cnt++;
