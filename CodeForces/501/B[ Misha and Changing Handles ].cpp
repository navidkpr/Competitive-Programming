...
<head>
    ...
    <meta name="X-Csrf-Token" content="b9b83e5d9646f6be7cbace1de512a193"/>
    ...
    <meta property="og:title" content="Submission #15598737 - Codeforces"/>
    ...
    <title>Submission #15598737 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='b9b83e5d9646f6be7cbace1de512a193'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F501%2Fsubmission%2F15598737">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b9b83e5d9646f6be7cbace1de512a193'/>
...
int main()
{
	...
	for (int i = 0; i < n; i++)
	{
		string s1, s2;
		cin >> s1 >> s2;
		if (mp2.find(s2) != mp2.end() || mp1.find(s2) != mp1.end())
			continue;
