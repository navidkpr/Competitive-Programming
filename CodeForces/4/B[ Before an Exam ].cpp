...
<head>
    ...
    <meta name="X-Csrf-Token" content="15b6552632994faa22fad3f0f44ec849"/>
    ...
    <meta property="og:title" content="Submission #14314562 - Codeforces"/>
    ...
    <title>Submission #14314562 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='15b6552632994faa22fad3f0f44ec849'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F4%2Fsubmission%2F14314562">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='15b6552632994faa22fad3f0f44ec849'/>
...
int main()
{
	...
	if (sum_time <= sum2 && sum_time >= sum1)
	{
		cout << "YES" << endl;
		for (int i = 0; i < n; i++)
		{
