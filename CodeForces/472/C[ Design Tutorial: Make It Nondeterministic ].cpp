...
<head>
    ...
    <meta name="X-Csrf-Token" content="2269a349db57522e532adc2596c81f87"/>
    ...
    <meta property="og:title" content="Submission #14806495 - Codeforces"/>
    ...
    <title>Submission #14806495 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='2269a349db57522e532adc2596c81f87'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F472%2Fsubmission%2F14806495">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='2269a349db57522e532adc2596c81f87'/>
...
int main()
{
	...
	mrk[perm[0]][0] = mrk[perm[0]][1] = 1;
	for (int i = 1; i < n; i++)
		for (int j = 0; j < 2; j++)
			for (int k = 0; k < 2; k++)
				if (mrk[perm[i - 1]][j] && (s[perm[i]][k] > s[perm[i - 1]][j]))
					mrk[perm[i]][k] = 1;
	// for (int i = 0; i < n; i++)
		// cout << mrk[i][0] << &#39; &#39; << mrk[i][1] << endl;
	if (!mrk[perm[n - 1]][0] && !mrk[perm[n - 1]][1])
		cout << "NO" << endl;
	else
		cout << "YES" << endl;
	return 0;
