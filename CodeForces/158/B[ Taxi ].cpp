...
<head>
    ...
    <meta name="X-Csrf-Token" content="f0e3be7db3fcbf124cf9f42685186be5"/>
    ...
    <meta property="og:title" content="Submission #10201201 - Codeforces"/>
    ...
    <title>Submission #10201201 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='f0e3be7db3fcbf124cf9f42685186be5'>&nbsp;</span>
...
<a href="//codeforces.com/vkcup2012"><img src="http://stat.codeforces.ru/images/vkcup2012-2.png"/>
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F158%2Fsubmission%2F10201201">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='f0e3be7db3fcbf124cf9f42685186be5'/>
...
int main()
{
	...
	int Cnt = 0;
	Cnt += CntG[4];
	int num2 = min(CntG[1], CntG[3]);
	Cnt += num2;
	CntG[1] -= num2;
	CntG[3] -= num2;
	int ans = CntG[1] + 2 * CntG[2];
	Cnt += ans / 4;
	Cnt += (ans % 4 != 0? 1: 0);
	Cnt += CntG[3];
	cout << Cnt;
