...
<head>
    ...
    <meta name="X-Csrf-Token" content="a1dacd700f5fa83d0ad1cef1c0d3a08c"/>
    ...
    <meta property="og:title" content="Submission #15763670 - Codeforces"/>
    ...
    <meta name="cc" content="223db0cc218772761a50289cbdd13895d21345c5"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15763670 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='a1dacd700f5fa83d0ad1cef1c0d3a08c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F6%2Fsubmission%2F15763670">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a1dacd700f5fa83d0ad1cef1c0d3a08c'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="B - President's Office" href="/contest/6/problem/B">6B</a>
		...
		for (int j = 0; j < m; j++)
		{
			if (arr[i][j] == per)
				for (int k = 0; k < 4; k++)
				{
					int x = change_x[k] + i;
					int y = change_y[k] + j;
					if (x >= 0 && x < n && y >= 0 && y < m && arr[x][y] != per)
						mrk[arr[x][y] - &#39;A&#39;] = 1;
				}
		}
	int cnt = 0;
