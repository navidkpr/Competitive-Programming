...
<head>
    ...
    <meta name="X-Csrf-Token" content="6148c7e64a31f96cd0da6f2f4154e7a9"/>
    ...
    <meta property="og:title" content="Submission #14323838 - Codeforces"/>
    ...
    <meta name="cc" content="29f73aac8e5aa098e1d9a174c1faf46782769921"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #14323838 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='6148c7e64a31f96cd0da6f2f4154e7a9'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F437%2Fsubmission%2F14323838">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='6148c7e64a31f96cd0da6f2f4154e7a9'/>
...
int main()
{
	...
	for (int i = 0; i < n; i++)
	{
		int min_sz = 10000000, max_sz = 0;
		for (int j = 0; j < n; j++)
			if (j != i)
			{
				min_sz = min(min_sz, arr[j]);
				max_sz = max(max_sz, arr[j]);
			}
		if (arr[i] >= max_sz * 2)
			mrk[i] = 1;
		if (arr[i] * 2 <= min_sz)
