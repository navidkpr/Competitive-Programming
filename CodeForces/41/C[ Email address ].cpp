...
<head>
    ...
    <meta name="X-Csrf-Token" content="cce82a488dbe2f9f55bb482a6c526987"/>
    ...
    <meta property="og:title" content="Submission #15774122 - Codeforces"/>
    ...
    <title>Submission #15774122 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='cce82a488dbe2f9f55bb482a6c526987'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F41%2Fsubmission%2F15774122">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='cce82a488dbe2f9f55bb482a6c526987'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="C - Email address" href="/contest/41/problem/C">41C</a>
...
int main() {
	string s;
	cin >> s;
	while (s.find("dot", 1) < s.size() - 3) {
		int k = s.find("dot", 1);
		s = s.substr(0, k) + &#39;.&#39; + s.substr(k + 3);
	}
	int k = s.find("at", 1);
	if (k < s.size() - 2)
