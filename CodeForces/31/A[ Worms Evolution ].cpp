...
<head>
    ...
    <meta name="X-Csrf-Token" content="d8eb4cadbaf029a9119764fb266c87ee"/>
    ...
    <meta property="og:title" content="Submission #14742171 - Codeforces"/>
    ...
    <meta name="cc" content="88e013a01292a42f1b0874b1c6a54cdc2d5c6416"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #14742171 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='d8eb4cadbaf029a9119764fb266c87ee'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F31%2Fsubmission%2F14742171">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d8eb4cadbaf029a9119764fb266c87ee'/>
...
int main()
{
	...
	for (int i = 0; i < n - 2; i++)
		for (int j = i + 1; j < n - 1; j++)
			for (int k = j + 1; k < n; k++)
				if (arr[k].first == arr[j].first + arr[i].first)
				{
					cout << arr[k].second << &#39; &#39; << arr[j].second << &#39; &#39; << arr[i].second << endl;
					return 0;
				}
	cout << -1 << endl;
	return 0;
