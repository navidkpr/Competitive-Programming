...
<head>
    ...
    <meta name="X-Csrf-Token" content="79e5ce244c2888e9cad187d559d241d0"/>
    ...
    <meta property="og:title" content="Submission #14336510 - Codeforces"/>
    ...
    <title>Submission #14336510 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='79e5ce244c2888e9cad187d559d241d0'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F469%2Fsubmission%2F14336510">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='79e5ce244c2888e9cad187d559d241d0'/>
...
int main()
{
	...
	for (int i = l; i <= r; i++)
	{
		...
		for (int j = 0; j < p; j++)
			for (int k = 0; k < q; k++)
				if (! (a[j].first > b[k].second || a[j].second < b[k].first))
					h = 1;
		if (h)
			cnt++;
		for (int j = 0; j < q; j++)
