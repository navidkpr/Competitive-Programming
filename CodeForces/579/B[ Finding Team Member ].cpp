...
<head>
    ...
    <meta name="X-Csrf-Token" content="ee5fdb07caea933c0f02dd5e65cba9ee"/>
    ...
    <meta property="og:title" content="Submission #15643406 - Codeforces"/>
    ...
    <title>Submission #15643406 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='ee5fdb07caea933c0f02dd5e65cba9ee'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F579%2Fsubmission%2F15643406">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ee5fdb07caea933c0f02dd5e65cba9ee'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    ...
    <td>2016-01-29 13:16:17</td>
    <td>2016-01-29 13:16:18</td>
    <td>
...
int main()
{
	...
	for (int i = 1; i < n; i++)
		for (int j = 0; j < i; j++)
		{
			int num;
			cin >> num;
			myvec.push_back(make_triple(num, i, j));
		}
	sort(myvec.begin(), myvec.end());
	for (int i = myvec.size() - 1; i >= 0; i--)
	{
		if (!mrk[myvec[i].second] && !mrk[myvec[i].third])
		{
			mrk[myvec[i].second] = mrk[myvec[i].third] = 1;
			d[myvec[i].second] = myvec[i].third;
			d[myvec[i].third] = myvec[i].second;
		}
	}
	for (int i = 0; i < n; i++)
		cout << d[i] + 1 << &#39; &#39;;
