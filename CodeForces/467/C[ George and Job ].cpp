...
<head>
    ...
    <meta name="X-Csrf-Token" content="56712d21377df150f186cef21d5e1af4"/>
    ...
    <meta property="og:title" content="Submission #15673815 - Codeforces"/>
    ...
    <title>Submission #15673815 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='56712d21377df150f186cef21d5e1af4'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F467%2Fsubmission%2F15673815">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='56712d21377df150f186cef21d5e1af4'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="C - George and Job" href="/contest/467/problem/C">467C</a>
...
int32_t main()
{
	...
	for (int i = n - m - 1; i >= 0; i--)
		for (int j = 1; j <= k; j++)
		{
			d[i][j] = d[i + 1][j];
			if (d[i + m][j - 1] != -1)
				d[i][j] = max(d[i][j], d[i + m][j - 1] + sum[i]);
		}
	cout << d[0][k] << endl;
	return 0;
}