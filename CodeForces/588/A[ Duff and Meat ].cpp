...
<head>
    ...
    <meta name="X-Csrf-Token" content="c3fec80d8d690a55cb8e80b1b36f9e39"/>
    ...
    <meta property="og:title" content="Submission #13660377 - Codeforces"/>
    ...
    <title>Submission #13660377 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='c3fec80d8d690a55cb8e80b1b36f9e39'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F588%2Fsubmission%2F13660377">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='c3fec80d8d690a55cb8e80b1b36f9e39'/>
...
int main()
{
	...
	while (cnt < cnt_a[0])
	{
		cnt += cnt_a[min_index[pt]] - cnt_a[pt + 1];
		sum += (cnt_a[min_index[pt]] - cnt_a[pt + 1]) * min_p[pt];
		pt = min_index[pt] - 1;
	}
	cout << sum << endl;
	return 0;
