...
<head>
    ...
    <meta name="X-Csrf-Token" content="fdc49a2fb4a9a8150851fd76781bcdbd"/>
    ...
    <meta property="og:title" content="Submission #14300689 - Codeforces"/>
    ...
    <title>Submission #14300689 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='fdc49a2fb4a9a8150851fd76781bcdbd'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F558%2Fsubmission%2F14300689">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='fdc49a2fb4a9a8150851fd76781bcdbd'/>
...
int main()
{
	...
	int max_1 = 0, min1 = MAX, min_index = 0;
	for (int i = 0; i < MAX; i++)
	{
		if (s[i] != -1 && cnt[i] == max_1)
			if (min1 > e[i] - s[i])
			{
				min1 = e[i] - s[i];
				min_index = i;
	...
	cout << s[min_index] + 1 << &#39; &#39; << e[min_index] + 1 << endl;
}