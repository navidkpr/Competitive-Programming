...
<head>
    ...
    <meta name="X-Csrf-Token" content="1b243571c953605384aae8bb84401301"/>
    ...
    <meta property="og:title" content="Submission #12587636 - Codeforces"/>
    ...
    <title>Submission #12587636 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='1b243571c953605384aae8bb84401301'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F208%2Fsubmission%2F12587636">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='1b243571c953605384aae8bb84401301'/>
...
int main()
{
	...
	for (int i = 0; i < s.size(); i++)
		...
		{
			int pt = i;
			while (s[pt] == &#39;W&#39; && s[pt + 1] == &#39;U&#39; && s[pt + 2] == &#39;B&#39;)
				pt += 3;
			if (i != 0 && pt < s.size())
				myvec.push_back(&#39; &#39;);
			i = pt - 1;
