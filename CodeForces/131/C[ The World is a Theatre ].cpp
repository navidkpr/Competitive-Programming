...
<head>
    ...
    <meta name="X-Csrf-Token" content="62b072949c703e99327e9c1ce3427cad"/>
    ...
    <meta property="og:title" content="Submission #14742095 - Codeforces"/>
    ...
    <title>Submission #14742095 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='62b072949c703e99327e9c1ce3427cad'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F131%2Fsubmission%2F14742095">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='62b072949c703e99327e9c1ce3427cad'/>
...
int main()
{
	int n, m, t;
	cin >> n >> m >> t;
	long long int num = ent(n + m, t);
	num -= ent(n, t) + ent(m, t) + ent(n, 1) * ent(m, t - 1) + ent(n, 2) * ent(m, t - 2) + ent(n, 3) * ent(m, t - 3);
	cout << num << endl;
	return 0;
}