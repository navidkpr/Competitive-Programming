...
<head>
    ...
    <meta name="X-Csrf-Token" content="eb655d20bba5f35c1ffecc86f875de64"/>
    ...
    <meta property="og:title" content="Submission #16436936 - Codeforces"/>
    ...
    <meta name="cc" content="195c01306e47ac278d902c48d1c4466caa423cc2"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #16436936 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='eb655d20bba5f35c1ffecc86f875de64'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F102%2Fsubmission%2F16436936">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='eb655d20bba5f35c1ffecc86f875de64'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - Clothes" href="/contest/102/problem/A">102A</a>
		...
		for (int j = i + 1; j < n; j++)
			for (int k = j + 1; k < n; k++)
			{
				if (edge[i][j] && edge[j][k] && edge[i][k])
					min_price = min(min_price, arr[i] + arr[j] + arr[k]);
			}
	if (min_price == INF)
		min_price = -1;
	cout << min_price << endl;
