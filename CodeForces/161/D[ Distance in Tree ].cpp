...
<head>
    ...
    <meta name="X-Csrf-Token" content="07c5a56ddcdce90dea1e99d07c101183"/>
    ...
    <meta property="og:title" content="Submission #14249316 - Codeforces"/>
    ...
    <meta name="cc" content="ef3b13993a4f14223c7022ad5f699f19b2bf36bf"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #14249316 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='07c5a56ddcdce90dea1e99d07c101183'>&nbsp;</span>
...
<a href="//codeforces.com/vkcup2012"><img src="http://stat.codeforces.ru/images/vkcup2012-2.png"/>
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F161%2Fsubmission%2F14249316">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='07c5a56ddcdce90dea1e99d07c101183'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/161">Problems</a></li>
        <li><a
                                        href="/contest/161/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/161/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/161/status">Status</a></li>
        <li><a
                                        href="/contest/161/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/161/room/1">Room</a></li>
        <li><a
                                        href="/contest/161/standings">Standings</a></li>
        <li><a
                                        href="/contest/161/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="D - Distance in Tree" href="/contest/161/problem/D">161D</a>
...
const int MAXK = 500 + 100;
vector <int> edge[MAXN];
vector <int> babe[MAXN];
bool mrk[MAXN];
int d[MAXN][MAXK];
...
void dfs(int v)
{
	...
	for (int i = 0; i < edge[v].size(); i++)
	{
		if (!mrk[edge[v][i]])
		{
			babe[v].push_back(edge[v][i]);
			dfs(edge[v][i]);
			h = 1;
			for (int j = 1; j < MAXK; j++)
				d[v][j] += d[edge[v][i]][j - 1];
		}
	}
}
...
int main()
{
	...
	// }
	for (int i = 0; i < n; i++)
		for (int j = 0; j < babe[i].size(); j++)
			for (int x = 1; x < k; x++)
			{
				sum += d[babe[i][j]][x - 1] * (d[i][k - x] - d[babe[i][j]][k - x - 1]);
				//cerr << i << &#39; &#39; << d[i][x] * (d[i][k - x] - d[babe[i][j]][k - x - 1]) << endl;
			}
	sum /= 2;
	for (int i = 0; i < n; i++)
		sum += d[i][k];
