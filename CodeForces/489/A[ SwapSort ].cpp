...
<head>
    ...
    <meta name="X-Csrf-Token" content="70f0b2215a2ace02202802f44f6c7846"/>
    ...
    <meta property="og:title" content="Submission #14007949 - Codeforces"/>
    ...
    <title>Submission #14007949 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='70f0b2215a2ace02202802f44f6c7846'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F489%2Fsubmission%2F14007949">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='70f0b2215a2ace02202802f44f6c7846'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - SwapSort" href="/contest/489/problem/A">489A</a>
...
void f(int n)
{
	if (n < 0)
		return;
	for (int i = 0; i < n; i++)
		if (arr[i] == b[n] && arr[n] != b[n])
		{
			myvec.push_back(make_pair(i, n));
			swap(arr[i], arr[n]);
			break;
		}
	f(n - 1);
