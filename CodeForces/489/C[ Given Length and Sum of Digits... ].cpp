...
<head>
    ...
    <meta name="X-Csrf-Token" content="dc3f9a7355d6c8df946f2a1cf16c04c7"/>
    ...
    <meta property="og:title" content="Submission #12984258 - Codeforces"/>
    ...
    <title>Submission #12984258 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='dc3f9a7355d6c8df946f2a1cf16c04c7'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F489%2Fsubmission%2F12984258">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='dc3f9a7355d6c8df946f2a1cf16c04c7'/>
...
int main() 
{
	...
	{
		cout << 1;
		for (int i = 0; i < m - myvec.size() - 1; i++)
			cout << 0;
		cout << myvec[myvec.size() - 1] - 1;
