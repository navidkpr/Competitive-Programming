...
<head>
    ...
    <meta name="X-Csrf-Token" content="8e00b3d765fb6f3afa70a6813ce425bb"/>
    ...
    <meta property="og:title" content="Submission #12985506 - Codeforces"/>
    ...
    <title>Submission #12985506 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='8e00b3d765fb6f3afa70a6813ce425bb'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F489%2Fsubmission%2F12985506">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='8e00b3d765fb6f3afa70a6813ce425bb'/>
...
void merge(int s1, int s2)
{
	...
	cerr << s1 << " : " << arr[s1] << &#39; &#39; << s2 << " : " << arr2[s2] << endl;
	cnt++;
	merge(s1 + 1, s2 + 1);
}
