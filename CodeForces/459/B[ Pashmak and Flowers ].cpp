...
<head>
    ...
    <meta name="X-Csrf-Token" content="60d5c394eca5bf7e1238fa2927e12191"/>
    ...
    <meta property="og:title" content="Submission #12727745 - Codeforces"/>
    ...
    <title>Submission #12727745 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='60d5c394eca5bf7e1238fa2927e12191'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F459%2Fsubmission%2F12727745">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='60d5c394eca5bf7e1238fa2927e12191'/>
...
int main()
{
	...
	long long int pt_2 = n - 1;
	while (pt_2 >= 0 && arr[pt_2] == arr[n - 1])
		pt_2--;
	//cerr << pt << &#39; &#39; << pt_2 << endl;
	cout << arr[n - 1] - arr[0] << &#39; &#39; << (pt) * (n - pt_2 - 1) << endl;
}
