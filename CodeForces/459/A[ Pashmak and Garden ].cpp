...
<head>
    ...
    <meta name="X-Csrf-Token" content="2127095c65e4f2e3d7823a29a282f3ac"/>
    ...
    <meta property="og:title" content="Submission #12699094 - Codeforces"/>
    ...
    <title>Submission #12699094 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='2127095c65e4f2e3d7823a29a282f3ac'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F459%2Fsubmission%2F12699094">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='2127095c65e4f2e3d7823a29a282f3ac'/>
...
int main()
{
	...
	{
		cout << x[0] + abs(y[1] - y[0]) << &#39; &#39; << y[0] << &#39; &#39; << x[0] + abs(y[1] - y[0]) << &#39; &#39; << y[1] << endl;
	}
	else
		cout << x[0] << &#39; &#39; << y[0] + abs(x[1] - x[0]) << &#39; &#39; << x[1] << &#39; &#39; << y[0] + abs(x[1] - x[0]) << endl;
	return 0;
}
