...
<head>
    ...
    <meta name="X-Csrf-Token" content="567515c2fb44117d94340b337021e16c"/>
    ...
    <meta property="og:title" content="Submission #12979656 - Codeforces"/>
    ...
    <title>Submission #12979656 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='567515c2fb44117d94340b337021e16c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F496%2Fsubmission%2F12979656">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='567515c2fb44117d94340b337021e16c'/>
...
int main() 
{
	...
	int min_dis = INF;
	for (int i = 0; i < n - 2; i++)
		min_dis = min(min_dis, arr[i + 2] - arr[i]);
	cout << max(max_dis, min_dis);
}