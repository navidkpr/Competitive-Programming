...
<head>
    ...
    <meta name="X-Csrf-Token" content="e8355e3f118f21a407219965daa39394"/>
    ...
    <meta property="og:title" content="Submission #15692127 - Codeforces"/>
    ...
    <title>Submission #15692127 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='e8355e3f118f21a407219965daa39394'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F507%2Fsubmission%2F15692127">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='e8355e3f118f21a407219965daa39394'/>
...
int32_t main()
{
	int r, x1, y1, x2, y2;
	cin >> r >> x1 >> y1 >> x2 >> y2;
	int num = abs_2(x1 - x2) * abs_2(x1 - x2) + abs_2(y1 - y2) * abs_2(y1 - y2);
	int fasele = sqrt(num);
	int sum = 0;
	// cerr << fasele << endl;
	if (fasele * fasele == num)
	{
		sum = fasele / (2 * r);
		if (fasele % (2 * r) != 0)
			sum += 1;
