...
<head>
    ...
    <meta name="X-Csrf-Token" content="e2cb78cde68cbfb2d5e35c2d1bc8f2df"/>
    ...
    <meta property="og:title" content="Submission #14249393 - Codeforces"/>
    ...
    <meta name="cc" content="2c92724cbef0d63e11dd4f45bb79ebfe940a9104"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #14249393 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='e2cb78cde68cbfb2d5e35c2d1bc8f2df'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F152%2Fsubmission%2F14249393">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='e2cb78cde68cbfb2d5e35c2d1bc8f2df'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - Marks" href="/contest/152/problem/A">152A</a>
...
int main()
{
	...
	for (int i = 0; i < n; i++)
		for (int j = 0; j < m; j++)
			max_grade[j] = max(max_grade[j], arr[i][j]);
	int cnt = 0;
	for (int i = 0; i < n; i++)
	{
		bool h = 0;
		for (int j = 0; j < m; j++)
			if (arr[i][j] == max_grade[j])
				h = 1;
		if (h == 1)
			cnt++;
	}
