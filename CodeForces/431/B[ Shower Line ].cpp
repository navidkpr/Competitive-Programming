...
<head>
    ...
    <meta name="X-Csrf-Token" content="70238425f8732e667cbe4739b79ad766"/>
    ...
    <meta property="og:title" content="Submission #15691977 - Codeforces"/>
    ...
    <title>Submission #15691977 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='70238425f8732e667cbe4739b79ad766'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F431%2Fsubmission%2F15691977">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='70238425f8732e667cbe4739b79ad766'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="B - Shower Line" href="/contest/431/problem/B">431B</a>
	...
	do
	{
		...
		for (int i = 0; i < n; i++)
			for (int j = i; j < n - 1; j+= 2)
				sum += arr[queue[i]][queue[i + 1]] + arr[queue[i + 1]][queue[i]];
		// for (int i = 0; i < n - 1; i++)
		// 	sum += arr[queue[i]][queue[i + 1]] * (n - i - 1);
		max_sum = max(max_sum, sum);
	}
	while (next_permutation(queue, queue + n));
	cout << max_sum << endl;
	return 0;
}