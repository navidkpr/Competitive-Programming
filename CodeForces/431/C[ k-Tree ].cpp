...
<head>
    ...
    <meta name="X-Csrf-Token" content="1f1fe7fdc99f2550fb494ac88785c6cd"/>
    ...
    <meta property="og:title" content="Submission #15615779 - Codeforces"/>
    ...
    <title>Submission #15615779 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='1f1fe7fdc99f2550fb494ac88785c6cd'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F431%2Fsubmission%2F15615779">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='1f1fe7fdc99f2550fb494ac88785c6cd'/>
...
int32_t main()
{
	...
	for (int i = 1; i <= n; i++)
	{
		...
		{
			if (j >= d)
				dp[i][1] = (dp[i][1] + dp[i - j][0] + dp[i - j][1]) % delta;
			else
			{
				dp[i][0] = (dp[i][0] + dp[i - j][0]) % delta;
				dp[i][1] = (dp[i][1] + dp[i - j][1]) % delta;
			}
		}
	}
	cout << dp[n][1] << endl;
