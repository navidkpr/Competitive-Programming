...
<head>
    ...
    <meta name="X-Csrf-Token" content="d6ae4c3fd15af96087ad32206c4403e5"/>
    ...
    <meta property="og:title" content="Submission #14041272 - Codeforces"/>
    ...
    <title>Submission #14041272 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='d6ae4c3fd15af96087ad32206c4403e5'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F492%2Fsubmission%2F14041272">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d6ae4c3fd15af96087ad32206c4403e5'/>
...
int main()
{
	...
	for (int i = 1; i < n - 1; i++)
		cin >> arr[i];
	sort (arr, arr + n);
	double max_dis = max(2 * arr[1], 2 * (l - arr[n - 2]));
	for (int i = 0; i < n - 1; i++)
	{
		if (max_dis < arr[i + 1] - arr[i])
		{
			//h = 0;
	...
	//cerr << max_dis << endl;
	cout << setprecision(10) << max_dis / 2 << endl;
	return 0;
}