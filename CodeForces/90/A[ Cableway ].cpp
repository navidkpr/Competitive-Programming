...
<head>
    ...
    <meta name="X-Csrf-Token" content="fd14c8b9bc2019711285d1b53c52fe20"/>
    ...
    <meta property="og:title" content="Submission #15985747 - Codeforces"/>
    ...
    <meta name="cc" content="5261e16e4d749b7ae4e374b1e9bdb98f593dd5c5"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15985747 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='fd14c8b9bc2019711285d1b53c52fe20'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F90%2Fsubmission%2F15985747">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='fd14c8b9bc2019711285d1b53c52fe20'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/90">Problems</a></li>
        <li><a
                                        href="/contest/90/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/90/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/90/status">Status</a></li>
        <li><a
                                        href="/contest/90/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/90/room/1">Room</a></li>
        <li><a
                                        href="/contest/90/standings">Standings</a></li>
        <li><a
                                        href="/contest/90/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - Cableway" href="/contest/90/problem/A">90A</a>
...
int32_t main()
{
	...
	r++; g++; b++;
	r /= 2; g /= 2;	b /= 2;
	// cout << max(1 + g * 3, max(2 + b * 3, r * 3)) << endl;
	int max_index = 0;
	int max_cnt = r;
	if (g >= max_cnt)
	{
	...
	cout << 30 + (max_cnt - 1) * 3 + max_index << endl;
	return 0;
}