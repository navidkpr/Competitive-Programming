...
<head>
    ...
    <meta name="X-Csrf-Token" content="cc0cc7d7def41ee729a5250b1d652cc7"/>
    ...
    <meta property="og:title" content="Submission #15674954 - Codeforces"/>
    ...
    <meta name="cc" content="a022f965837f653abdcfffd4377ce00e91493e6a"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15674954 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='cc0cc7d7def41ee729a5250b1d652cc7'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F274%2Fsubmission%2F15674954">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='cc0cc7d7def41ee729a5250b1d652cc7'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/274">Problems</a></li>
        <li><a
                                        href="/contest/274/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/274/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/274/status">Status</a></li>
        <li><a
                                        href="/contest/274/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/274/room/1">Room</a></li>
        <li><a
                                        href="/contest/274/standings">Standings</a></li>
        <li><a
                                        href="/contest/274/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - k-Multiple Free Set" href="/contest/274/problem/A">274A</a>
    ...
    <td>2016-01-30 11:15:53</td>
    <td>2016-01-30 11:15:54</td>
    <td>
...
int32_t main()
{
	...
	for (int i = 0; i < n; i++)
		if (!mrk[i])
		{
			if (*lower_bound(arr, arr + n, arr[i] * k) == arr[i] * k)
				*(mrk + (lower_bound(arr, arr + n, arr[i] * k) - arr)) = 1;
			cnt++;
		}
	cout << cnt << endl;
	return 0;
