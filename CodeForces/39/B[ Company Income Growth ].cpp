...
<head>
    ...
    <meta name="X-Csrf-Token" content="81f892dc204a5978f0a3b62914c32503"/>
    ...
    <meta property="og:title" content="Submission #15987627 - Codeforces"/>
    ...
    <meta name="cc" content="987c6cb22c49957d8b2110d5168cf8402f0fd4db"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15987627 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='81f892dc204a5978f0a3b62914c32503'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F39%2Fsubmission%2F15987627">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='81f892dc204a5978f0a3b62914c32503'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/39">Problems</a></li>
        <li><a
                                        href="/contest/39/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/39/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/39/status">Status</a></li>
        <li><a
                                        href="/contest/39/standings">Standings</a></li>
        <li><a
                                        href="/contest/39/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="B - Company Income Growth" href="/contest/39/problem/B">39B</a>
    ...
    <td>2016-02-13 16:11:23</td>
    <td>2016-02-13 16:11:24</td>
    <td>
...
int32_t main()
{
	...
	// 	cerr << cnt[i] << &#39; &#39;;
	// cerr << endl;
	int max_index = -1, max_cnt = 0;
	for (int i = 0; i < n; i++)
		if (arr[i] == 1 && max_cnt < cnt[i])
		{
			max_index = i;
			max_cnt = cnt[i];
		}
