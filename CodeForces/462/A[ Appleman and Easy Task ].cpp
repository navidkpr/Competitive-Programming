...
<head>
    ...
    <meta name="X-Csrf-Token" content="d6e4ffd65239c3cb1c6a55956cff6bd1"/>
    ...
    <meta property="og:title" content="Submission #12742121 - Codeforces"/>
    ...
    <title>Submission #12742121 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='d6e4ffd65239c3cb1c6a55956cff6bd1'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F462%2Fsubmission%2F12742121">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d6e4ffd65239c3cb1c6a55956cff6bd1'/>
...
int main()
{
	...
	for (int i = 1; i <= n; i++)
		for (int j = 1; j <= n; j++)
		{
			int cnt = 0;
			for (int k = 0; k < 4; k++)
				if (c[i + change_x[k]][j + change_y[k]] == &#39;o&#39;)
					cnt++;
			if (cnt % 2 != 0)
			{
				cout << "NO" << endl;
