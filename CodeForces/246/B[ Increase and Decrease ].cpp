...
<head>
    ...
    <meta name="X-Csrf-Token" content="630eed9981afe939bd92bdf5fc6a16f7"/>
    ...
    <meta property="og:title" content="Submission #15675485 - Codeforces"/>
    ...
    <meta name="cc" content="ae286ae41994c07b6e5e7370e22bdb25ba07235d"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15675485 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='630eed9981afe939bd92bdf5fc6a16f7'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F246%2Fsubmission%2F15675485">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='630eed9981afe939bd92bdf5fc6a16f7'/>
...
int32_t main()
{
	...
	// cout << max((sum % n + n) % n, n - ((sum % n) + n) % n) << endl;
	cout << n - 1 << endl;
	return 0;
}