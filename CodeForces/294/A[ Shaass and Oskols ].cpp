...
<head>
    ...
    <meta name="X-Csrf-Token" content="9288ea268e8a8646a870979f97ecea87"/>
    ...
    <meta property="og:title" content="Submission #14787628 - Codeforces"/>
    ...
    <meta name="cc" content="49eab9c8f81bf9da5723ad286e3f4da4395df7ce"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #14787628 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='9288ea268e8a8646a870979f97ecea87'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F294%2Fsubmission%2F14787628">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='9288ea268e8a8646a870979f97ecea87'/>
...
int main()
{
	...
	{
		int wire, bird;
		cin >> wire >> bird; wire--; bird--;
		arr[wire - 1] += bird;
		arr[wire + 1] += arr[wire] - bird - 1;
		arr[wire] = 0;
	}
	for (int i = 0; i < n; i++)
		cout << arr[i] << endl;
