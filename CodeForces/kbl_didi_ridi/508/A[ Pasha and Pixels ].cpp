...
<head>
    ...
    <meta name="X-Csrf-Token" content="8416fb1d042a476e54293cbc5d335d6c"/>
    ...
    <meta property="og:title" content="Submission #13023981 - Codeforces"/>
    ...
    <title>Submission #13023981 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='8416fb1d042a476e54293cbc5d335d6c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F508%2Fsubmission%2F13023981">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='8416fb1d042a476e54293cbc5d335d6c'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - Pasha and Pixels" href="/contest/508/problem/A">508A</a>
...
bool change_x[4] = {1, 1, 0, 0};
bool change_y[4] = {1, 0, 1, 0};
...
int main()
{
	...
	for (int i = 0; i < k; i++)
	{
		...
		{
			bool h = 1;
			if (x - change_x[j] >= n - 1 || x - change_x[j] < 0 || y - change_y[j] >= m - 1 || y - change_y[j] < 0)
				continue;
			for (int k = 0; k < 4; k++)
				if (chart[x - change_x[j] + change_x[k]][y - change_y[j] + change_y[k]] == 0)
					h = 0;
			if (h == 1)
			{
				cout << i + 1 << endl;
