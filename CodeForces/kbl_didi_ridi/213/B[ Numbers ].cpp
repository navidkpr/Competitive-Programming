...
<head>
    ...
    <meta name="X-Csrf-Token" content="ae00e7fbe6ee45219827342a9f0cfa6a"/>
    ...
    <meta property="og:title" content="Submission #18504821 - Codeforces"/>
    ...
    <meta name="cc" content="ebf6785e48a40afdab9039e893a396e796d7021d"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #18504821 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='ae00e7fbe6ee45219827342a9f0cfa6a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F213%2Fsubmission%2F18504821">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ae00e7fbe6ee45219827342a9f0cfa6a'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/213">Problems</a></li>
        <li><a
                                        href="/contest/213/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/213/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/213/status">Status</a></li>
        <li><a
                                        href="/contest/213/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/213/room/1">Room</a></li>
        <li><a
                                        href="/contest/213/standings">Standings</a></li>
        <li><a
                                        href="/contest/213/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="B - Numbers" href="/contest/213/problem/B">213B</a>
...
int32_t main()
{
	...
	for (int i = 2; i < 10; i++)
		for (int j = 0; j <= n; j++)
			for (int k = arr[i]; k <= n - j; k++)
				dp_2[j + k][i] = (dp_2[j + k][i] + dp_2[j][i - 1] * dp[j + k][k]) % MOD;
	for (int i = 1; i <= n; i++)
		for (int j = arr[0]; j <= n - i; j++)
			dp_2[i + j][0] = (dp_2[i + j][0] + dp_2[i][9] * dp[i + j - 1][j]) % MOD;
	int sum = 0;
	for (int i = 0; i <= n; i++)
		sum = (sum + dp_2[i][0]) % MOD;
	cout << sum << endl;
	return 0;
}