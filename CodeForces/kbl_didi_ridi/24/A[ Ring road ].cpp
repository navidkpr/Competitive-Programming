...
<head>
    ...
    <meta name="X-Csrf-Token" content="8d53f792aa3fde7588d71edacec0a499"/>
    ...
    <meta property="og:title" content="Submission #15749096 - Codeforces"/>
    ...
    <meta name="cc" content="50bd85ab8f27ba7caf148f2eda2e64294161a132"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15749096 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='8d53f792aa3fde7588d71edacec0a499'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F24%2Fsubmission%2F15749096">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='8d53f792aa3fde7588d71edacec0a499'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/24">Problems</a></li>
        <li><a
                                        href="/contest/24/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/24/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/24/status">Status</a></li>
        <li><a
                                        href="/contest/24/standings">Standings</a></li>
        <li><a
                                        href="/contest/24/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - Ring road" href="/contest/24/problem/A">24A</a>
...
void dfs(int v, int n)
{
	...
	if (cnt == n)
		...
		{
			if (edge[v][i].first != p[v])
				sum += edge[v][i].second;
		}
	
	else
		for (int i = 0; i < edge[v].size(); i++)
		if (!mrk[edge[v][i].first])
		{
			p[edge[v][i].first] = v;
			dfs(edge[v][i].first, n);
			sum += edge[v][i].second;
		}
