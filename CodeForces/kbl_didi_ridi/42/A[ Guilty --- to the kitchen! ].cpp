...
<head>
    ...
    <meta name="X-Csrf-Token" content="2d2b34d440939b6560f517c2e3b9fb27"/>
    ...
    <meta property="og:title" content="Submission #15749140 - Codeforces"/>
    ...
    <meta name="cc" content="7fe75d001d0b2856e49931c0999ffb467dc791a0"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15749140 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='2d2b34d440939b6560f517c2e3b9fb27'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F42%2Fsubmission%2F15749140">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='2d2b34d440939b6560f517c2e3b9fb27'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/42">Problems</a></li>
        <li><a
                                        href="/contest/42/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/42/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/42/status">Status</a></li>
        <li><a
                                        href="/contest/42/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/42/room/1">Room</a></li>
        <li><a
                                        href="/contest/42/standings">Standings</a></li>
        <li><a
                                        href="/contest/42/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - Guilty --- to the kitchen!" href="/contest/42/problem/A">42A</a>
    ...
    <td>2016-02-02 14:46:38</td>
    <td>2016-02-02 14:46:39</td>
    <td>
...
int32_t main()
{
	...
	double min_num = v;
	for (int i = 0; i < n; i++)
		min_num = min(min_num, b[i] / a[i]);
	cout << min(v, sum * min_num) << endl;
}