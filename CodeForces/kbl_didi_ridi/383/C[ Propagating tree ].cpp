...
<head>
    ...
    <meta name="X-Csrf-Token" content="fe849337c0aeb24e7b68f7ece6165270"/>
    ...
    <meta property="og:title" content="Submission #14897078 - Codeforces"/>
    ...
    <meta name="cc" content="be465d9c3565feeadc9e048221cbb90bfc92cc26"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #14897078 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='fe849337c0aeb24e7b68f7ece6165270'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F383%2Fsubmission%2F14897078">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='fe849337c0aeb24e7b68f7ece6165270'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/383">Problems</a></li>
        <li><a
                                        href="/contest/383/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/383/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/383/status">Status</a></li>
        <li><a
                                        href="/contest/383/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/383/room/1">Room</a></li>
        <li><a
                                        href="/contest/383/standings">Standings</a></li>
        <li><a
                                        href="/contest/383/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="C - Propagating tree" href="/contest/383/problem/C">383C</a>
...
void add(int s, int e, int l, int r, int ind, int v)
{
    if (e <= l || r <= s || l >= r)
        return;
    if (e >= r && s <= l)
    ...
    int m = (l + r) / 2;
    add(s, e, l, m, ind * 2 + 0, v);
    add(s, e, m, r, ind * 2 + 1, v);
}

int get(int s, int e, int ind, int x)
{
    if (s == e - 1)
        return seg[ind];
    int m = (s + e) / 2;
    int ans = seg[ind];
    if (x < m)
        ans += get(s, m, ind * 2 + 0, x);
    else
        ans += get(m, e, ind * 2 + 1, x);
    return ans;
}
