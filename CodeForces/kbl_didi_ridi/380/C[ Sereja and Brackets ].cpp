...
<head>
    ...
    <meta name="X-Csrf-Token" content="66ba70aead6039284640f1f3b7743fd3"/>
    ...
    <meta property="og:title" content="Submission #15421118 - Codeforces"/>
    ...
    <meta name="cc" content="c121d038e12de73ea01dd4e3473de510fe674b2a"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15421118 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='66ba70aead6039284640f1f3b7743fd3'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F380%2Fsubmission%2F15421118">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='66ba70aead6039284640f1f3b7743fd3'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/380">Problems</a></li>
        <li><a
                                        href="/contest/380/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/380/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/380/status">Status</a></li>
        <li><a
                                        href="/contest/380/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/380/room/1">Room</a></li>
        <li><a
                                        href="/contest/380/standings">Standings</a></li>
        <li><a
                                        href="/contest/380/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="C - Sereja and Brackets" href="/contest/380/problem/C">380C</a>
...
string s1;
int seg[4 * MAXN], end1[4 * MAXN];
int now, max_dif;

void give(int s, int e, int l, int r, int ind)
{
	if (e <= l || r <= s)
		return;
	if (e >= r && s <= l)
	{
		max_dif = max(max_dif, now + seg[ind]);
		now += end1[ind];
		return;
	}
	int m = (l + r) / 2;
	give(s, e, l, m, ind * 2 + 0);
	give(s, e, m, r, ind * 2 + 1);
}
...
void set(int l, int r, int ind)
{
	if (l == r - 1)
	{
		if (s1[l] == &#39;(&#39;)
			...
			end1[ind] = 1;
		seg[ind] = max(end1[ind], 0);
		return;
	}
	int m = (l + r) / 2;
	set(l, m, 2 * ind + 0);
	set(m, r, 2 * ind + 1);
	seg[ind] = max(seg[2 * ind + 0], end1[2 * ind + 0] + seg[2 * ind + 1]);
	end1[ind] = end1[ind * 2 + 0] + end1[ind * 2 + 1];
}
