...
<head>
    ...
    <meta name="X-Csrf-Token" content="0949a6eee4654c36d487e1376494c55c"/>
    ...
    <meta property="og:title" content="Submission #14834627 - Codeforces"/>
    ...
    <meta name="cc" content="6eaaf2513ab1819956fea971dde794c05fdd87e5"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #14834627 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='0949a6eee4654c36d487e1376494c55c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F336%2Fsubmission%2F14834627">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0949a6eee4654c36d487e1376494c55c'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/336">Problems</a></li>
        <li><a
                                        href="/contest/336/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/336/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/336/status">Status</a></li>
        <li><a
                                        href="/contest/336/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/336/room/1">Room</a></li>
        <li><a
                                        href="/contest/336/standings">Standings</a></li>
        <li><a
                                        href="/contest/336/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - Vasily the Bear and Triangle" href="/contest/336/problem/A">336A</a>
...
int main()
{
	...
	// vector <int> myvec;
	if (sign(x) == -1)
		cout << sign(x) * sum << &#39; &#39; << &#39;0&#39; << &#39; &#39; << &#39;0&#39; << &#39; &#39; << sum * sign(y) << endl;
	else
		cout  << &#39;0&#39; << &#39; &#39; << sum * sign(y) << &#39; &#39; << sign(x) * sum << &#39; &#39; << 0 << endl;
}