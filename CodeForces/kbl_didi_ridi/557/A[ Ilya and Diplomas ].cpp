...
<head>
    ...
    <meta name="X-Csrf-Token" content="57624af5c939704da39c51440519d2b0"/>
    ...
    <meta property="og:title" content="Submission #12973395 - Codeforces"/>
    ...
    <meta name="cc" content="ffc281cbcfff34ad2db972fd9d080d6db82d8473"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #12973395 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='57624af5c939704da39c51440519d2b0'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F557%2Fsubmission%2F12973395">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='57624af5c939704da39c51440519d2b0'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/557">Problems</a></li>
        <li><a
                                        href="/contest/557/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/557/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/557/status">Status</a></li>
        <li><a
                                        href="/contest/557/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/557/room/1">Room</a></li>
        <li><a
                                        href="/contest/557/standings">Standings</a></li>
        <li><a
                                        href="/contest/557/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - Ilya and Diplomas" href="/contest/557/problem/A">557A</a>
...
int min_dip[3], max_dip[3]; 	

int main () {
	int n;
	cin >> n;
	for (int i = 0; i < 3; i++)
		cin >> min_dip[i] >> max_dip[i];
	for (int i = 0; i < 3; i++) {
		int num = n;
		for (int j = i + 1; j < 3; j++)
			num -= min_dip[j];
		cout << min(max_dip[i], num) << &#39; &#39;;
		n -= min(max_dip[i], num);
	}
	cout << endl;
	return 0;
