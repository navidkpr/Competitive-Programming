...
<head>
    ...
    <meta name="X-Csrf-Token" content="54a8e440f79a42dc4737b0259ab66311"/>
    ...
    <meta property="og:title" content="Submission #15770462 - Codeforces"/>
    ...
    <meta name="cc" content="b46ec67512213ec33b672f054e931327c23389e4"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15770462 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='54a8e440f79a42dc4737b0259ab66311'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F38%2Fsubmission%2F15770462">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='54a8e440f79a42dc4737b0259ab66311'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="B - Chess" href="/contest/38/problem/B">38B</a>
...
int32_t main()
{
	...
	mrk[num2][num4] = 1;
	// cerr << num2 << &#39; &#39; << num4 << endl;
	mrk[num1 - 2][num3 - 1] = mrk[num1 - 1][num3 - 2] = mrk[num1 + 1][num3 + 2] = mrk[num1 + 2][num3 + 1] = 1;
	mrk[num1 - 2][num3 + 1] = mrk[num1 - 1][num3 + 2] = mrk[num1 + 1][num3 - 2] = mrk[num1 + 2][num3 - 1] = 1;
	mrk[num2 - 2][num4 - 1] = mrk[num2 - 1][num4 - 2] = mrk[num2 + 1][num4 + 2] = mrk[num2 + 2][num4 + 1] = 1;
	mrk[num2 - 2][num4 + 1] = mrk[num2 - 1][num4 + 2] = mrk[num2 + 1][num4 - 2] = mrk[num2 + 2][num4 - 1] = 1;
	int cnt = 0;
	for (int i = 2; i < 10; i++)
		for (int j = 2; j < 10; j++)
