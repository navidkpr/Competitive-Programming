...
<head>
    ...
    <meta name="X-Csrf-Token" content="4c8746ea0ee7863053d8f4b11b66e96e"/>
    ...
    <meta property="og:title" content="Submission #14248929 - Codeforces"/>
    ...
    <meta name="cc" content="ad24f33999cbe203c23eefd1a394599f326ab0cd"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #14248929 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='4c8746ea0ee7863053d8f4b11b66e96e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F222%2Fsubmission%2F14248929">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='4c8746ea0ee7863053d8f4b11b66e96e'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="E - Decoding Genome" href="/contest/222/problem/E">222E</a>
         - <span title="problem revision">74</span>
    </td>
    <td>
    GNU C++
    </td>
...
const long long int delta = (long long)(1000*1000*1000 + 7);
const int MAXM = 160;
pair <char, char> arr[MAXM*MAXM];
long long int matrix[MAXM][MAXM];
long long int ans[MAXM][MAXM];

void pow(long long int n, long long int m)
{
	long long int ans2[MAXM][MAXM];
	for (int i = 0; i < n; i++)
		for (int j = 0; j < n; j++)
			ans2[i][j] = matrix[i][j];
	if (m == 0)
	...
	if (m == 2)
	{
		...
		for (int i = 0; i < n; i++)
			for (int j = 0; j < n; j++)
				for (int k = 0; k < n; k++)
					matrix[i][j] = ((long long)ans2[i][k] * ans2[k][j] + matrix[i][j]) % delta;
	}
	else if (m % 2 == 0)
	{
		pow(n, m / 2);
	...
	else
	{
		...
		for (int i = 0; i < n; i++)
			for (int j = 0; j < n; j++)
				for (int k = 0; k < n; k++)
					matrix[i][j] = ((long long)ans2[i][k] * ans[k][j] + matrix[i][j]) % delta;
	}
}
...
int main()
{
	...
	for (int i = 0; i < k; i++)
	{
		...
		if (arr[i].first >= &#39;a&#39; && arr[i].first <= &#39;z&#39;)
			...
			num1 = arr[i].first - &#39;A&#39; + 26;
		if (arr[i].second >= &#39;a&#39; && arr[i].second <= &#39;z&#39;)
			num2 = arr[i].second - &#39;a&#39;;
		else
			num2 = arr[i].second - &#39;A&#39; + 26;
		matrix[num1][num2] = 0;
		//cerr << num1 << &#39; &#39; << num2 << endl;
	}
	for (int i = 0; i < m; i++)
