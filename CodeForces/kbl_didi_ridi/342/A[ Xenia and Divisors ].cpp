...
<head>
    ...
    <meta name="X-Csrf-Token" content="c7c53017bfc2a3e86e24e3ebc285c82e"/>
    ...
    <meta property="og:title" content="Submission #15672046 - Codeforces"/>
    ...
    <meta name="cc" content="f2672d860c9f1f741d42ee2d90fbc21ef4a304ae"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15672046 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='c7c53017bfc2a3e86e24e3ebc285c82e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F342%2Fsubmission%2F15672046">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='c7c53017bfc2a3e86e24e3ebc285c82e'/>
...
int main()
{
	...
	for (int i = 0; i < cnt[4]; i++)
		myvec.push_back(make_triple(1, 2, 4));
	cnt[2] -= cnt[4];
	cnt[1] -= cnt[4];
	cnt[4] = 0;
	if (cnt[2] < 0)
	...
	for (int i = 0; i < cnt[2]; i++)
		myvec.push_back(make_triple(1, 2, 6));
	cnt[1] -= cnt[2];
	cnt[6] -= cnt[2];
	cnt[2] -= cnt[2];
	if (cnt[6] < 0)
	...
	for (int i = 0; i < cnt[6]; i++)
		myvec.push_back(make_triple(1, 3, 6));
	cnt[1] -= cnt[6];
	cnt[3] -= cnt[6];
	cnt[6] -= cnt[6];
	if (cnt[1] != 0 || cnt[3] != 0)
	...
	for (int i = 0; i < myvec.size(); i++)
		cout << myvec[i].first << &#39; &#39; << myvec[i].second << &#39; &#39; << myvec[i].third << endl;
}