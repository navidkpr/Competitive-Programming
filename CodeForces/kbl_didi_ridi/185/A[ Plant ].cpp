...
<head>
    ...
    <meta name="X-Csrf-Token" content="4cb007a494ce3456594dcc8a62897436"/>
    ...
    <meta property="og:title" content="Submission #16397313 - Codeforces"/>
    ...
    <meta name="cc" content="8b2fc1ed3e59fc5b29adab7335c58c8b52f69211"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #16397313 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='4cb007a494ce3456594dcc8a62897436'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F185%2Fsubmission%2F16397313">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='4cb007a494ce3456594dcc8a62897436'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/185">Problems</a></li>
        <li><a
                                        href="/contest/185/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/185/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/185/status">Status</a></li>
        <li><a
                                        href="/contest/185/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/185/room/1">Room</a></li>
        <li><a
                                        href="/contest/185/standings">Standings</a></li>
        <li><a
                                        href="/contest/185/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - Plant" href="/contest/185/problem/A">185A</a>
...
int32_t main()
{
	...
	cout << (pow(2, n - 1) * (pow(2, n) + 1)) % delta << endl;
}