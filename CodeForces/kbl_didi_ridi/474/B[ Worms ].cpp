...
<head>
    ...
    <meta name="X-Csrf-Token" content="cbcc2aee06afda9092f1bff9fcc51ee6"/>
    ...
    <meta property="og:title" content="Submission #12741896 - Codeforces"/>
    ...
    <title>Submission #12741896 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='cbcc2aee06afda9092f1bff9fcc51ee6'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F474%2Fsubmission%2F12741896">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='cbcc2aee06afda9092f1bff9fcc51ee6'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    ...
    <td>2015-08-29 13:26:23</td>
    <td>2015-08-29 13:26:24</td>
    <td>
...
int main()
{
	...
	for (int i = 0; i < m; i++)
	{
		while (arr2[i].first > sum)
		{
			sum += arr[pt];
			pt++;
		}
		javab[arr2[i].second] = pt;
		//cerr << pt << endl;
	}
	for (int i = 0; i < m; i++)
		cout << javab[i] << endl;
