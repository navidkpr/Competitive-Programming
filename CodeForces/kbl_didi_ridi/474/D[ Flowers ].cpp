...
<head>
    ...
    <meta name="X-Csrf-Token" content="d279df230887802c857861fb0bbf6834"/>
    ...
    <meta property="og:title" content="Submission #15614190 - Codeforces"/>
    ...
    <title>Submission #15614190 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='d279df230887802c857861fb0bbf6834'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F474%2Fsubmission%2F15614190">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d279df230887802c857861fb0bbf6834'/>
...
int32_t main()
{
	...
	for (int i = 2; i < n; i++)
	{
		...
		if (i - k >= 0)
			f[i] = (f[i] + f[i - k]) % delta;
		sum[i] = (sum[i - 1] + f[i]) % delta;
	}
	for (int i = 0; i < t; i++)
	{
		int s, e;
		cin >> s >> e;
		cout << ((sum[e] - sum[s - 1]) % delta + delta) % delta << endl;
	}
