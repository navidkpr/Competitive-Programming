...
<head>
    ...
    <meta name="X-Csrf-Token" content="3db26aaaa010fc311fa994b62bfc7b67"/>
    ...
    <meta property="og:title" content="Submission #14329613 - Codeforces"/>
    ...
    <title>Submission #14329613 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='3db26aaaa010fc311fa994b62bfc7b67'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F379%2Fsubmission%2F14329613">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='3db26aaaa010fc311fa994b62bfc7b67'/>
...
int main()
{
	...
	for (int i = 0; i < n; i++)
	{
		min_r = max(min_r + 1, arr[i].first);
		b[i] = min_r;
	}
	for (int i = 0; i < n; i++)
		javab[arr[i].second] = b[i];
	for (int i = 0; i < n; i++)
		cout << javab[i] << &#39; &#39;;
	cout << endl;
	return 0;
