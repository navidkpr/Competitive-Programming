...
<head>
    ...
    <meta name="X-Csrf-Token" content="445f11446f7312970b953c08114e7bdf"/>
    ...
    <meta property="og:title" content="Submission #15647617 - Codeforces"/>
    ...
    <meta name="cc" content="d64563d096117262c805b34f50dc4eaa0552e17d"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15647617 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='445f11446f7312970b953c08114e7bdf'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F215%2Fsubmission%2F15647617">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='445f11446f7312970b953c08114e7bdf'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    ...
    <td>2016-01-29 17:54:34</td>
    <td>2016-01-29 17:54:35</td>
    <td>
...
int32_t main()
{
	...
	for (int i = 0; i < m; i++)
		cin >> b[i];
	int cnt_max = 0, max_rat = 0;
	for (int i = 0; i < n; i++)
		for (int j = 0; j < m; j++)
			if (b[j] % arr[i] == 0 && max_rat < b[j] / arr[i])
			{
				cnt_max = 1;
				max_rat = b[j] / arr[i];
			}
			else if (b[j] % arr[i] == 0 && max_rat == b[j] / arr[i])
				cnt_max++;
	cout << cnt_max << endl;
	return 0;
}