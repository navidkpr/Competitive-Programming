...
<head>
    ...
    <meta name="X-Csrf-Token" content="0d89c452e09f122d10dfafc4688d012e"/>
    ...
    <meta property="og:title" content="Submission #16468138 - Codeforces"/>
    ...
    <meta name="cc" content="363019287521ae4acb2a25c1cbce9ab14b721806"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #16468138 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='0d89c452e09f122d10dfafc4688d012e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F585%2Fsubmission%2F16468138">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0d89c452e09f122d10dfafc4688d012e'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/585">Problems</a></li>
        <li><a
                                        href="/contest/585/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/585/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/585/status">Status</a></li>
        <li><a
                                        href="/contest/585/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/585/room/1">Room</a></li>
        <li><a
                                        href="/contest/585/standings">Standings</a></li>
        <li><a
                                        href="/contest/585/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="B - Phillip and Trains" href="/contest/585/problem/B">585B</a>
...
void dfs(int x, int y)
{
	...
	for (int i = 0; i < 3; i++)
	{
		int new_x = x + change_x[i], new_y = y + 3;
		if (new_x < 0 || new_y < 0 || new_y >= m + 3 || new_x >= n)
			continue;
		if (arr[new_x][y + 1] == &#39;.&#39; && arr[new_x][y + 2] == &#39;.&#39; && arr[new_x][y + 3] == &#39;.&#39; && !mrk[new_x][new_y] && arr[x][y + 1] == &#39;.&#39;)
			dfs(new_x, new_y);
	}
}
