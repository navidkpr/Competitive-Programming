...
<head>
    ...
    <meta name="X-Csrf-Token" content="f26c44aee6a641476fb373315941155d"/>
    ...
    <meta property="og:title" content="Submission #10201430 - Codeforces"/>
    ...
    <title>Submission #10201430 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='f26c44aee6a641476fb373315941155d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F116%2Fsubmission%2F10201430">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='f26c44aee6a641476fb373315941155d'/>
