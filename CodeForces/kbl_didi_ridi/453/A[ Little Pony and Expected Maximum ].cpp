...
<head>
    ...
    <meta name="X-Csrf-Token" content="0fbff15bff95299c6991c2b6413595d6"/>
    ...
    <meta property="og:title" content="Submission #15672204 - Codeforces"/>
    ...
    <meta name="cc" content="95c5ab2f8e9e1859131f7d99608d5d326c15fafe"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15672204 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='0fbff15bff95299c6991c2b6413595d6'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F453%2Fsubmission%2F15672204">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0fbff15bff95299c6991c2b6413595d6'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/453">Problems</a></li>
        <li><a
                                        href="/contest/453/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/453/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/453/status">Status</a></li>
        <li><a
                                        href="/contest/453/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/453/room/1">Room</a></li>
        <li><a
                                        href="/contest/453/standings">Standings</a></li>
        <li><a
                                        href="/contest/453/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - Little Pony and Expected Maximum" href="/contest/453/problem/A">453A</a>
...
int32_t main()
{
	...
	for (int i = 1; i < m; i++)
		sum += pow(i / m, n);
	cout << setprecision(8) << m - sum << endl;
}