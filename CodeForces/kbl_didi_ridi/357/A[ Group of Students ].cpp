...
<head>
    ...
    <meta name="X-Csrf-Token" content="9edb04464347f043104021a0b825d10d"/>
    ...
    <meta property="og:title" content="Submission #14321463 - Codeforces"/>
    ...
    <meta name="cc" content="ad5c6a4acb5316663bc207876dee15ff5760e6b1"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #14321463 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='9edb04464347f043104021a0b825d10d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F357%2Fsubmission%2F14321463">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='9edb04464347f043104021a0b825d10d'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - Group of Students" href="/contest/357/problem/A">357A</a>
...
int main()
{
	...
	for (int i = 0; i < n; i++)
		d_2[i] = sum - d[i];
	for (int i = 0; i < n; i++)
		if (d[i] <= y && d[i] >= x && d_2[i] >= x && d_2[i] <= y)
		{
			cout << i + 1 << endl;
			return 0;
		}
