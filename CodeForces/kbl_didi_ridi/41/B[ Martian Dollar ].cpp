...
<head>
    ...
    <meta name="X-Csrf-Token" content="dba22a0911ee3e2b038c7473eba8baa4"/>
    ...
    <meta property="og:title" content="Submission #15988653 - Codeforces"/>
    ...
    <title>Submission #15988653 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='dba22a0911ee3e2b038c7473eba8baa4'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F41%2Fsubmission%2F15988653">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='dba22a0911ee3e2b038c7473eba8baa4'/>
...
int32_t main()
{
	...
	for (int i = 0; i < n; i++)
		for (int j = i + 1; j < n; j++)
			max_sum = max(max_sum, ((b / arr[i]) * arr[j]) + (b % arr[i]));
	cout << max_sum << endl;
	return 0;
}