...
<head>
    ...
    <meta name="X-Csrf-Token" content="508ed991168a0e473d2c60dd7f083ad0"/>
    ...
    <meta property="og:title" content="Submission #14657473 - Codeforces"/>
    ...
    <meta name="cc" content="19e2e6e1386a05bfdb1e508112037fefdd58a8ea"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #14657473 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='508ed991168a0e473d2c60dd7f083ad0'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F81%2Fsubmission%2F14657473">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='508ed991168a0e473d2c60dd7f083ad0'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/81">Problems</a></li>
        <li><a
                                        href="/contest/81/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/81/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/81/status">Status</a></li>
        <li><a
                                        href="/contest/81/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/81/room/1">Room</a></li>
        <li><a
                                        href="/contest/81/standings">Standings</a></li>
        <li><a
                                        href="/contest/81/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - Plug-in" href="/contest/81/problem/A">81A</a>
...
int main()
{
	...
	for (int i = 1; i < n; i++)
	{
		...
		int cnt = 0;
		while (myvec.size() > 0 && myvec[myvec.size() - 1] == s[i])
		{
			cnt++;
			myvec.pop_back();
		}
