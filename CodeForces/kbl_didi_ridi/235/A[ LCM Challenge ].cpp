...
<head>
    ...
    <meta name="X-Csrf-Token" content="bb129801dcc6233c24db27d39e2dd4e0"/>
    ...
    <meta property="og:title" content="Submission #15677943 - Codeforces"/>
    ...
    <meta name="cc" content="cf3b93895d416c0231ced34f70d3398757c4ec75"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15677943 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='bb129801dcc6233c24db27d39e2dd4e0'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F235%2Fsubmission%2F15677943">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='bb129801dcc6233c24db27d39e2dd4e0'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/235">Problems</a></li>
        <li><a
                                        href="/contest/235/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/235/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/235/status">Status</a></li>
        <li><a
                                        href="/contest/235/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/235/room/1">Room</a></li>
        <li><a
                                        href="/contest/235/standings">Standings</a></li>
        <li><a
                                        href="/contest/235/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - LCM Challenge" href="/contest/235/problem/A">235A</a>
...
int32_t main()
{
	...
	else
	{
		if (!check(n, n - 3))
			cout << n * (n - 1) * (n - 3) << endl;
		else if (!check(n, n - 4) && !check(n - 1, n - 4))
			cout << max((n - 1) * (n - 2) * (n - 3), n * (n - 1) * (n - 4)) << endl;
		else
