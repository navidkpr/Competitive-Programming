...
<head>
    ...
    <meta name="X-Csrf-Token" content="a0d9e91ba7ebfd366a86ad359eb763fe"/>
    ...
    <meta property="og:title" content="Submission #15689493 - Codeforces"/>
    ...
    <title>Submission #15689493 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='a0d9e91ba7ebfd366a86ad359eb763fe'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F576%2Fsubmission%2F15689493">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a0d9e91ba7ebfd366a86ad359eb763fe'/>
...
int32_t main()
{
	...
	for (int i = 0; i < myvec.size(); i++)
		for (int j = myvec[i]; j <= n; j *= myvec[i])
			javab.push_back(j);
