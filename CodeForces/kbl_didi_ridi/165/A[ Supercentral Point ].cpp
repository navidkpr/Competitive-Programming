...
<head>
    ...
    <meta name="X-Csrf-Token" content="b6e189dd2a086671b589af20fd6cf275"/>
    ...
    <meta property="og:title" content="Submission #13394469 - Codeforces"/>
    ...
    <title>Submission #13394469 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='b6e189dd2a086671b589af20fd6cf275'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F165%2Fsubmission%2F13394469">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b6e189dd2a086671b589af20fd6cf275'/>
	...
	for (int i = 0; i < n; i++)
	{
		...
		for (int j = 0; j < n; j++)
			if (point[i].first < point[j].first && point[i].second == point[j].second)
				mrk[0] = 1;
			else if (point[i].first > point[j].first && point[i].second == point[j].second)
			mrk[1] = 1;
			else if (point[i].first == point[j].first && point[i].second < point[j].second)
			mrk[2] = 1;
			else if (point[i].first == point[j].first && point[i].second > point[j].second)
