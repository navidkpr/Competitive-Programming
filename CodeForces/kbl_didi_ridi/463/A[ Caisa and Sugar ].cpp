...
<head>
    ...
    <meta name="X-Csrf-Token" content="485b2bb568166863ebba0fbe480fa203"/>
    ...
    <meta property="og:title" content="Submission #12964101 - Codeforces"/>
    ...
    <title>Submission #12964101 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='485b2bb568166863ebba0fbe480fa203'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F463%2Fsubmission%2F12964101">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='485b2bb568166863ebba0fbe480fa203'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - Caisa and Sugar" href="/contest/463/problem/A">463A</a>
...
int main()
{
	...
	for (int i = 0; i < n; i++)
		if (x[i] < s || (x[i] == s && y[i] == 0))
		{
			h = 1;
			if (y[i] != 0)
				max_change = max(max_change, 100 - y[i]);
		}
	if (h == 1)
