...
<head>
    ...
    <meta name="X-Csrf-Token" content="3763b90836d4d23f33d9cf876a14e518"/>
    ...
    <meta property="og:title" content="Submission #14233805 - Codeforces"/>
    ...
    <title>Submission #14233805 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='3763b90836d4d23f33d9cf876a14e518'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F598%2Fsubmission%2F14233805">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='3763b90836d4d23f33d9cf876a14e518'/>
...
<tr>
    ...
    <td>
            Contestant:<br/>
<a href="/profile/kbl_didi_ridi" title="Specialist kbl_didi_ridi" class="rated-user user-cyan">kbl_didi_ridi</a>    </td>
    <td>
    ...
    <td>2015-11-13 18:57:48</td>
    <td>2015-11-14 20:09:32</td>
    <td>
...
void run_dfs(int x, int y)
{
	...
	mrk[x][y] = 1;
	myvec2.push_back(make_pair(x, y));
	for (int i = 0; i < 4; i++)
		if (!mrk[x + change_x[i]][y + change_y[i]])
			run_dfs(x + change_x[i], y + change_y[i]);
}
...
int main()
{
	...
	for (int i = 0; i < t; i++)
	{
		...
		{
			//cerr << myvec2[i].first << myvec2[i].second << endl;
			mrk[myvec2[i].first][myvec2[i].second] = 0;
			javab[myvec2[i].first][myvec2[i].second] = cnt;
		}
		//cerr << "FUC<" << endl;
		cnt = 0;
		myvec2.clear();
