...
<head>
    ...
    <meta name="X-Csrf-Token" content="120c29094bc5beec277775f152d138f0"/>
    ...
    <meta property="og:title" content="Submission #14231881 - Codeforces"/>
    ...
    <title>Submission #14231881 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='120c29094bc5beec277775f152d138f0'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F598%2Fsubmission%2F14231881">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='120c29094bc5beec277775f152d138f0'/>
...
<a href="/profile/kbl_didi_ridi" title="Specialist kbl_didi_ridi" class="rated-user user-cyan">kbl_didi_ridi</a>    </td>
    ...
    <td>2015-11-13 18:38:55</td>
    <td>2015-11-14 20:08:00</td>
    <td>
...
int main()
{
	...
	for (int i = 0; i < n; i++)
	{
		...
		r[i]--;
		l[i]--;
		long long int num = r[i] + 1 - l[i];
		for (int j = l[i]; j <= r[i]; j++)
			s[j] = s1[(j - k[i] - l[i] +  k[i] * num) % num + l[i]];
		cerr << s << endl;
	}
	cout << s << endl;
	return 0;
