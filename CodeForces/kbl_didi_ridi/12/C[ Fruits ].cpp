...
<head>
    ...
    <meta name="X-Csrf-Token" content="6552dc5d48a6a81706f3381c94f1fef1"/>
    ...
    <meta property="og:title" content="Submission #15763516 - Codeforces"/>
    ...
    <title>Submission #15763516 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='6552dc5d48a6a81706f3381c94f1fef1'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F12%2Fsubmission%2F15763516">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='6552dc5d48a6a81706f3381c94f1fef1'/>
...
int32_t main()
{
	...
	for (int i = pt - 1; i >= 0; i--)
		sum += arr[pt - i - 1] * cnt[i];
	cout << sum << &#39; &#39;;
	sum = 0;
	for (int i = pt - 1; i >= 0; i--)
		sum += arr[n - pt + i] * cnt[i];
	cout << sum << endl;
}