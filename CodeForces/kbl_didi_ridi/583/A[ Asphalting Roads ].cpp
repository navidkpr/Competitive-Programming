...
<head>
    ...
    <meta name="X-Csrf-Token" content="7e57352170239cea4015bd697630299d"/>
    ...
    <meta property="og:title" content="Submission #14040858 - Codeforces"/>
    ...
    <title>Submission #14040858 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='7e57352170239cea4015bd697630299d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F583%2Fsubmission%2F14040858">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='7e57352170239cea4015bd697630299d'/>
...
int main()
{
	...
	for (int i = 0; i < n * n; i++)
		if (!mrk_r[arr[i].first] && !mrk_c[arr[i].second])
		{
			mrk_r[arr[i].first] = mrk_c[arr[i].second] = 1;
			myvec.push_back(i + 1);
		}
