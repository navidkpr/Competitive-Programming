...
<head>
    ...
    <meta name="X-Csrf-Token" content="a2a922a85e19e8c8e262ec2790721df0"/>
    ...
    <meta property="og:title" content="Submission #16308611 - Codeforces"/>
    ...
    <title>Submission #16308611 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='a2a922a85e19e8c8e262ec2790721df0'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F61%2Fsubmission%2F16308611">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a2a922a85e19e8c8e262ec2790721df0'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="D - Eternal Victory" href="/contest/61/problem/D">61D</a>
...
void dfs(int v)
{
    ...
    for(int i = 0; i < a[v].size(); i ++)
    {
	  ...
	  if(mark[u]) continue;
	  dfs(u);
	  dp[v] = max(dp[v], dp[u] + a[v][i].second);
    }
}
main()
{
    ...
    for(int i = 1; i < n; i ++)
    {
	  int d, k, w; cin >> d >> k >> w; d --; k --; sum += w;
	  a[d].push_back(make_pair(k, w));
	  a[k].push_back(make_pair(d, w));
    }
    dfs(0);
    cout << 2 * sum - dp[0] << endl;
    return 0;
 }