...
<head>
    ...
    <meta name="X-Csrf-Token" content="a550fb1e6787cc0c9fb5642c091b52d6"/>
    ...
    <meta property="og:title" content="Submission #16194837 - Codeforces"/>
    ...
    <title>Submission #16194837 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='a550fb1e6787cc0c9fb5642c091b52d6'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F61%2Fsubmission%2F16194837">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a550fb1e6787cc0c9fb5642c091b52d6'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="B - Hard Work" href="/contest/61/problem/B">61B</a>
...
int32_t main()
{
	...
	for (int i = 0; i < s3.size(); i++)
		...
		{
			s3 = s3.substr(0, i) + s3.substr(i + 1, s3.size() - i + 1);
			i--;
		}
	for (int i = 0; i < s3.size(); i++)
		s3[i] = unsign(s3[i]);
	...
	for (int i = 0; i < n; i++)
		for (int j = 0; j < arr[i].size(); j++)
			if (unsign(arr[i][j]) != &#39; &#39;)
				arr[i][j] = unsign(arr[i][j]);
			else
			{
				arr[i] = arr[i].substr(0, j) + arr[i].substr(j + 1, arr[i].size() - j + 1);
				j--;
			}
	// for (int i = 0; i < n; i++)
	// 	cerr << arr[i] << endl;
