...
<head>
    ...
    <meta name="X-Csrf-Token" content="077bf794ff4f2da7c7a753e5b60edb1f"/>
    ...
    <meta property="og:title" content="Submission #14806974 - Codeforces"/>
    ...
    <meta name="cc" content="82a595efab2f3810198529dccb1716a0ef6f201c"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #14806974 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='077bf794ff4f2da7c7a753e5b60edb1f'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F493%2Fsubmission%2F14806974">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='077bf794ff4f2da7c7a753e5b60edb1f'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - Vasya and Football" href="/contest/493/problem/A">493A</a>
...
int main()
{
	...
	for (int i = 0; i < n; i++)
	{
		...
		if (team == &#39;h&#39;)
			...
			ans = 1;
		if (cnt[m][ans] < 2 && kind == &#39;r&#39;)
		{
			cout << tea[ans] << &#39; &#39; << m << &#39; &#39; << t << endl;
			cnt[m][ans] += 2;
		}
		else if (kind == &#39;y&#39;)
		{
