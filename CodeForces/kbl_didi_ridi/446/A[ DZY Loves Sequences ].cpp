...
<head>
    ...
    <meta name="X-Csrf-Token" content="d5349762ee2f2291ee83c01ff511deda"/>
    ...
    <meta property="og:title" content="Submission #15649262 - Codeforces"/>
    ...
    <meta name="cc" content="a5d5346d993a409ee78b9309cfe2368a59dd92a9"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15649262 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='d5349762ee2f2291ee83c01ff511deda'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F446%2Fsubmission%2F15649262">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d5349762ee2f2291ee83c01ff511deda'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/446">Problems</a></li>
        <li><a
                                        href="/contest/446/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/446/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/446/status">Status</a></li>
        <li><a
                                        href="/contest/446/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/446/room/1">Room</a></li>
        <li><a
                                        href="/contest/446/standings">Standings</a></li>
        <li><a
                                        href="/contest/446/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - DZY Loves Sequences" href="/contest/446/problem/A">446A</a>
    ...
    <td>2016-01-29 19:34:58</td>
    <td>2016-01-29 19:34:59</td>
    <td>
...
int main()
{
	...
	for (int i = n - 2; i >= 0; i--)
		if (arr[i] < arr[i + 1])
			...
			d_2[i] = 1;
	int max_l = d_2[1] + 1;
	max_l = max(max_l, d[n - 2] + 1);
	for (int i = 1; i < n - 1; i++)
		if (arr[i - 1] <= arr[i + 1] - 2)
			max_l = max(max_l, d_2[i + 1] + d[i - 1] + 1);
		else
			max_l = max(max_l, max(d_2[i + 1] + 1, d[i - 1] + 1));
	cout << max_l << endl;
	return 0;
}