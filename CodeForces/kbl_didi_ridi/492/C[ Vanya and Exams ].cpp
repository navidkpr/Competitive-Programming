...
<head>
    ...
    <meta name="X-Csrf-Token" content="9cddf55009dd4f8e9e1f00a96a50052e"/>
    ...
    <meta property="og:title" content="Submission #15598224 - Codeforces"/>
    ...
    <title>Submission #15598224 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='9cddf55009dd4f8e9e1f00a96a50052e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F492%2Fsubmission%2F15598224">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='9cddf55009dd4f8e9e1f00a96a50052e'/>
...
int32_t main()
{
	...
	int sum = 0;
	int pt = 0;
	// cerr << now_pt << &#39; &#39; << end_pt << endl;
	while (now_pt < end_pt)
	{
		pair <int, int> ans = arr[pt];
		// cerr << ans.first << &#39; &#39; << ans.second << endl;
		sum += ans.first * min(end_pt - now_pt, r - ans.second);
		now_pt += min(end_pt - now_pt, r - ans.second);
		pt++;
	}
	cout << sum << endl;
	return 0;
