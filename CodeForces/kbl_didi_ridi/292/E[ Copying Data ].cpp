...
<head>
    ...
    <meta name="X-Csrf-Token" content="7dd72e981ae3d4d75e5d46fb212de4db"/>
    ...
    <meta property="og:title" content="Submission #14545923 - Codeforces"/>
    ...
    <meta name="cc" content="9ff5f333cc3efd647762a258c95379a9f31e020c"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #14545923 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='7dd72e981ae3d4d75e5d46fb212de4db'>&nbsp;</span>
...
<a href="/croc2013"><img src="/images/custom/croc-en.gif"/></a>
<span style="padding:1.5em;">All-Russian Programming Championship CROC 2013</span>
</div>
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F292%2Fsubmission%2F14545923">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='7dd72e981ae3d4d75e5d46fb212de4db'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/292">Problems</a></li>
        <li><a
                                        href="/contest/292/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/292/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/292/status">Status</a></li>
        <li><a
                                        href="/contest/292/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/292/room/1">Room</a></li>
        <li><a
                                        href="/contest/292/standings">Standings</a></li>
        <li><a
                                        href="/contest/292/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="E - Copying Data" href="/contest/292/problem/E">292E</a>
...
void update(int l, int r, int s, int e, int val, int t, int ind)
{
	if (r <= s || e <= l)
		return;
	if (r >= e && l <= s)
	...
	if (s >= e - 1)
		return;
	int m = (s + e) / 2;
	update(l, r, s, m, val, t, ind * 2 + 0);
	update(l, r, m, e, val, t, ind * 2 + 1);
}

pair <int, int> give(int s, int e, int x, int ind)
{
	if (s == e - 1)
		return make_pair(seg[ind], tim[ind]);
	pair <int, int> ans;
	int m = (s + e) / 2;
	if (x < m)
		ans = give(s, m, x, ind * 2 + 0);
	else
		ans = give(m, e, x, ind * 2 + 1);
	if (tim[ind] > ans.second)
		ans = make_pair(seg[ind], tim[ind]);
	return ans;
}
...
int main()
{
	...
	for (int i = 0; i < q; i++)
	{
		...
		if (t == 1)
		{
			int x, y, k;
			cin >> x >> y >> k; x--; y--;
			update(y, y + k, 0, n, x - y, i, 1);
		}
		else
		{
			int x; cin >> x; x--;
			pair <int, int> num = give(0, n, x, 1);
			//cerr << num.first << endl;
			if (num.second == -1)
				cout << b[x] << endl;
			else
				cout << a[num.first + x] << endl;
