...
<head>
    ...
    <meta name="X-Csrf-Token" content="39b019159b3d484c508e90a2cf51c801"/>
    ...
    <meta property="og:title" content="Submission #15745394 - Codeforces"/>
    ...
    <meta name="cc" content="3e9c5f5917ba8b4f8e1597d29a1f08421b03f1d9"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15745394 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='39b019159b3d484c508e90a2cf51c801'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F23%2Fsubmission%2F15745394">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='39b019159b3d484c508e90a2cf51c801'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/23">Problems</a></li>
        <li><a
                                        href="/contest/23/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/23/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/23/status">Status</a></li>
        <li><a
                                        href="/contest/23/standings">Standings</a></li>
        <li><a
                                        href="/contest/23/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - You're Given a String..." href="/contest/23/problem/A">23A</a>
...
int32_t main()
{
	...
	for (int i = 0; i < s.size(); i++)
		...
		{
			int cnt = 0;
			while (s[i + cnt] == s[j + cnt] && j + cnt < s.size())
				cnt++;
