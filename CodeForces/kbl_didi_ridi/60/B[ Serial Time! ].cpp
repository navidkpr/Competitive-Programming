...
<head>
    ...
    <meta name="X-Csrf-Token" content="17b89f048dc1ac170349801f3fb66b0d"/>
    ...
    <meta property="og:title" content="Submission #16197139 - Codeforces"/>
    ...
    <meta name="cc" content="1a08f20e48b6139bde3ef869efdbbf077f2fb58a"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #16197139 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='17b89f048dc1ac170349801f3fb66b0d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F60%2Fsubmission%2F16197139">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='17b89f048dc1ac170349801f3fb66b0d'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/60">Problems</a></li>
        <li><a
                                        href="/contest/60/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/60/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/60/status">Status</a></li>
        <li><a
                                        href="/contest/60/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/60/room/1">Room</a></li>
        <li><a
                                        href="/contest/60/standings">Standings</a></li>
        <li><a
                                        href="/contest/60/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="B - Serial Time!" href="/contest/60/problem/B">60B</a>
...
int change_x[6] = {1, -1, 0, 0, 0, 0};
int change_y[6] = {0, 0, 1, -1, 0, 0};
int change_z[6] = {0, 0, 0, 0, 1, -1};
bool mrk[MAXN][MAXN][MAXN];
...
void dfs(int x, int y, int z)
{
	...
	for (int i = 0; i < 6; i++)
	{
		int x1 = x + change_x[i], y1 = y + change_y[i], z1 = z + change_z[i];
		if (x1 >= 0 && y1 >= 0 && z1 >= 0 && arr[x1][y1][z1] == &#39;.&#39; && !mrk[x1][y1][z1])
			dfs(x1, y1, z1);
	}
}
