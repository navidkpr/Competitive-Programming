...
<head>
    ...
    <meta name="X-Csrf-Token" content="45ac760bdf44fe865e77d32c6ca45553"/>
    ...
    <meta property="og:title" content="Submission #14786029 - Codeforces"/>
    ...
    <title>Submission #14786029 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='45ac760bdf44fe865e77d32c6ca45553'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F538%2Fsubmission%2F14786029">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='45ac760bdf44fe865e77d32c6ca45553'/>
...
int main()
{
	...
	cin >> s;
	int cnt_s = 0, cnt_e = 0;
	for (int i = 0; i < min((int)s.size(), (int)cf.size()); i++)
		if (s[i] != cf[i])
			break;
		else
			cnt_s++;
	for (int i = s.size() - 1; i >= max(0, (int)s.size() - (int)cf.size()); i--)
		if (s[i] != cf[i - (int)s.size() + (int)cf.size()])
			break;
		else
			cnt_e++;
	cerr << cnt_s << &#39; &#39; << cnt_e << endl;
	if (cnt_s + cnt_e >= cf.size())
		cout << "YES" << endl;
	else
		cout << "NO" << endl;
	return 0;
