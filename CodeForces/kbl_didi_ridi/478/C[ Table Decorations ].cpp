...
<head>
    ...
    <meta name="X-Csrf-Token" content="36c9e8bf14421c01a25b6eed8229a221"/>
    ...
    <meta property="og:title" content="Submission #14557657 - Codeforces"/>
    ...
    <title>Submission #14557657 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='36c9e8bf14421c01a25b6eed8229a221'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F478%2Fsubmission%2F14557657">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='36c9e8bf14421c01a25b6eed8229a221'/>
...
int main()
{
    ...
    for (int i = 0; i < n; i++)
        cin >> arr[i];
    sort(arr, arr + n);
    cout << (arr[0] + arr[1] + min(arr[2], 2 * arr[0] + 2 * arr[1])) / 3;
}