...
<head>
    ...
    <meta name="X-Csrf-Token" content="a047421b9420175bb11b88d519ee5129"/>
    ...
    <meta property="og:title" content="Submission #14227370 - Codeforces"/>
    ...
    <title>Submission #14227370 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='a047421b9420175bb11b88d519ee5129'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F476%2Fsubmission%2F14227370">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a047421b9420175bb11b88d519ee5129'/>
...
int main()
{
	...
	for (int i = 0; i < n; i++)
		if (b[i] == &#39;?&#39;)
			cnt_q++;
	//cerr << cnt_0 << &#39; &#39; << ans  << &#39; &#39; << cnt_q << endl;
	if (ans > cnt_0)
	{
		cout << 0 << endl;
		return 0;
	}
	if (n - cnt_0 < n - ans - cnt_q)
	{
		cout << 0 << endl;
		return 0;
	}
	int javab = fact(cnt_q) / ((fact(cnt_0 - ans) * fact(cnt_q - cnt_0 + ans)));
	//cerr << javab << endl;
	cout << setprecision(13) << (long double)(javab) / (long double)(tavan_2[cnt_q]) << endl;
	return 0;
}