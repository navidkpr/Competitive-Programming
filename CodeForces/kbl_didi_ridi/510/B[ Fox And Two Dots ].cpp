...
<head>
    ...
    <meta name="X-Csrf-Token" content="de597cbcfdc37fc3f7357ec7b6e80cb9"/>
    ...
    <meta property="og:title" content="Submission #14658696 - Codeforces"/>
    ...
    <title>Submission #14658696 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='de597cbcfdc37fc3f7357ec7b6e80cb9'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F510%2Fsubmission%2F14658696">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='de597cbcfdc37fc3f7357ec7b6e80cb9'/>
...
char c[MAXN][MAXN];
int change_x[4] = {1, 0, 0, -1}, change_y[4] = {0, 1, -1, 0};
...
void dfs(int v, int root)
{
	...
	for (int i = 0; i < edge[v].size(); i++)
	{
		...
		else if (mrk[edge[v][i]] && edge[v][i] != p[v] && v != root)
		{
			// cerr << edge[v][i] << &#39; &#39; << v << endl;
			h = 1;
		}
	}
	...
	for (int i = 0; i < n; i++)
		for (int j = 0; j < m; j++)
			for (int k = 0; k < 4; k++)
			{
				...
				if (c[i][j] == c[x][y])
				{
					// cerr << i << &#39; &#39; << j << &#39; &#39; << x << &#39; &#39; << y << c[i][j] << &#39; &#39; << c[x][y] << endl;
					edge[i * m + j].push_back(x * m + y);
				}
			}
	// for (int i = 0; i < n * m; i++)
	// 	for (int j = 0; j < edge[i].size(); j++)
	// 		cerr << i << &#39; &#39; << edge[i][j] << endl;
	run_dfs(n * m);
	if (h)
		cout << "Yes" << endl;
	else
