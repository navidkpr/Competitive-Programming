...
<head>
    ...
    <meta name="X-Csrf-Token" content="222f894ed0a4a1ddd18abcf08c81acd8"/>
    ...
    <meta property="og:title" content="Submission #15762999 - Codeforces"/>
    ...
    <title>Submission #15762999 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='222f894ed0a4a1ddd18abcf08c81acd8'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F6%2Fsubmission%2F15762999">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='222f894ed0a4a1ddd18abcf08c81acd8'/>
...
int32_t main()
{
	...
	for (int i = 0; i < n; i++)
		cin >> arr[i];
	for (int i = 1; i < n; i++)
		t[i][0] = t[i - 1][0] + arr[i - 1];
	for (int i = n - 2; i >= 0; i--)
		t[i][1] = t[i + 1][1] + arr[i + 1];
	int cnt = 0;
	for (int i = 0; i < n; i++)
		if (t[i][0] <= t[i][1])
			cnt++;
