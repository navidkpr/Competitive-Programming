...
<head>
    ...
    <meta name="X-Csrf-Token" content="73c00d42419f8ebbfc796a56767e7310"/>
    ...
    <meta property="og:title" content="Submission #12696084 - Codeforces"/>
    ...
    <title>Submission #12696084 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='73c00d42419f8ebbfc796a56767e7310'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F490%2Fsubmission%2F12696084">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='73c00d42419f8ebbfc796a56767e7310'/>
...
int main()
{
	...
	for (int i = 0; i < n; i++)
	{
		int num;
		cin >> num;
		sub[num - 1].push_back(i + 1);	
	}
	int cnt = INF;
	for (int i = 0; i < 3; i++)
		cnt = min(cnt, (int)sub[i].size());
	cout << cnt << endl;
	for (int i = 0; i < cnt; i++)
	{
		for (int j = 0; j < 3; j++)
