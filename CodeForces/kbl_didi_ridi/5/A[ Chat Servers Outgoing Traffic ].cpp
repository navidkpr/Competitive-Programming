...
<head>
    ...
    <meta name="X-Csrf-Token" content="088d9da423817cf7666dfc636b89c501"/>
    ...
    <meta property="og:title" content="Submission #15744030 - Codeforces"/>
    ...
    <title>Submission #15744030 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='088d9da423817cf7666dfc636b89c501'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F5%2Fsubmission%2F15744030">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='088d9da423817cf7666dfc636b89c501'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="A - Chat Servers Outgoing Traffic" href="/contest/5/problem/A">5A</a>
	...
	while (getline(cin, op))
	{
		if (op[0] != &#39;+&#39; && op[0] != &#39;-&#39;)
		{
			for (int i = 0; i < op.size(); i++)
				if (op[i] == &#39;:&#39;)
				{
					sum += st.size() * (op.size() - i - 1);
					break;
				}
		}
		if (op[0] == &#39;+&#39;)
			st.insert(op.substr(1, op.size() - 1));
		if (op[0] == &#39;-&#39;)
			st.erase(op.substr(1 , op.size() - 1));
	}
	cout << sum << endl;
	return 0;
}