...
<head>
    ...
    <meta name="X-Csrf-Token" content="097ed6de8be74349298327ea18a57f92"/>
    ...
    <meta property="og:title" content="Submission #16304985 - Codeforces"/>
    ...
    <meta name="cc" content="635f29aa420db501b5ab4042e8483d4d35fdb2ba"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #16304985 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='097ed6de8be74349298327ea18a57f92'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F5%2Fsubmission%2F16304985">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='097ed6de8be74349298327ea18a57f92'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="B - Center Alignment" href="/contest/5/problem/B">5B</a>
...
int32_t main()
{
	...
	int max_l = 0;
	int pt = 0;
	while (getline(cin, arr[pt]))
	{
		max_l = max(max_l, (int)arr[pt].size());
		cerr << pt << endl;
		pt++;
	}
	int n = pt;
	...
	{
		cout << &#39;*&#39;;
		if ((max_l - arr[i].size()) % 2 == 1)
		{
			pt++;
			if (pt % 2 == 1)
			{
				for (int j = 0; j < (max_l - arr[i].size()) / 2; j++)
					cout << &#39; &#39;;
				cout << arr[i];
				for (int j = 0; j < (max_l - arr[i].size() + 1) / 2; j++)
					cout << &#39; &#39;;
			}
			else
			{
