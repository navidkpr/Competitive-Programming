...
<head>
    ...
    <meta name="X-Csrf-Token" content="3bc57ebc5368bc80394bc99fd9d4c2fb"/>
    ...
    <meta property="og:title" content="Submission #16465282 - Codeforces"/>
    ...
    <title>Submission #16465282 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='3bc57ebc5368bc80394bc99fd9d4c2fb'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F540%2Fsubmission%2F16465282">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='3bc57ebc5368bc80394bc99fd9d4c2fb'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    <td>
        <a title="C - Ice Cave" href="/contest/540/problem/C">540C</a>
...
int32_t main()
{
	...
	for (int i = 0; i < 4; i++)
	{
		int new_x = r2 + change_x[i], new_y = c2 + change_y[i];
		if (new_x < n && new_y < m && new_x >= 0 && new_y >= 0 && arr[new_x][new_y] == &#39;.&#39;)
			cnt++;
	}
	// cerr << cnt << endl;
	if (cnt >= 2 && mrk[r2][c2])
