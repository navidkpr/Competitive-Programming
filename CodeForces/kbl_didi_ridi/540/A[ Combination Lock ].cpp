...
<head>
    ...
    <meta name="X-Csrf-Token" content="488a371aa3f38c7f3aefe7ea141252a0"/>
    ...
    <meta property="og:title" content="Submission #12592775 - Codeforces"/>
    ...
    <title>Submission #12592775 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='488a371aa3f38c7f3aefe7ea141252a0'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F540%2Fsubmission%2F12592775">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='488a371aa3f38c7f3aefe7ea141252a0'/>
...
int main()
{
	...
	int cnt = 0;
	for (int i = 0; i < n; i++)
		cnt += min(abs((int)(s1[i] - s2[i])), 10 - abs((int)(s1[i] - s2[i])));
	cout << cnt << endl;
}
