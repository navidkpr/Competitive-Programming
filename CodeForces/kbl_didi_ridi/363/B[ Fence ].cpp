...
<head>
    ...
    <meta name="X-Csrf-Token" content="287d03e37662533d8982e3232790e632"/>
    ...
    <meta property="og:title" content="Submission #11131392 - Codeforces"/>
    ...
    <meta name="cc" content="ba402bac96c5349f0e47bbf07d011e1d2628d3b9"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #11131392 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='287d03e37662533d8982e3232790e632'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F363%2Fsubmission%2F11131392">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='287d03e37662533d8982e3232790e632'/>
...
<a href="/profile/kbl_didi_ridi" title="Expert kbl_didi_ridi" class="rated-user user-blue">kbl_didi_ridi</a>    </td>
    ...
    <td>2015-05-18 07:08:32</td>
    <td>2015-05-18 07:08:36</td>
    <td>
...
int main()
{
	...
	for (int i = 0; i < k; i++)
		d[0] += a[i];
	for (int i = 1; i <= n - k; i++)
		d[i] = d[i - 1] + a[i + k - 1] - a[i - 1];
	int min = 100000000, min_index = -1;
	for (int i = 0; i <= n - k; i++)
		if (d[i] < min)
		{
			min = d[i];
